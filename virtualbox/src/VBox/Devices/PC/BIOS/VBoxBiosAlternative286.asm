...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 03fh, 02bh, 0bdh, 081h, 068h, 091h
_softrst:                                    ; 0xf0076 LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 0c8h, 02dh, 08ch, 03bh, 08ch, 03bh
_dskacc:                                     ; 0xf0082 LB 0x2e
    db  000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 02fh, 02ah, 0e4h, 02ah, 000h, 000h, 000h, 000h
    db  0fdh, 07fh, 0ddh, 080h, 03ah, 090h, 0e2h, 090h, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
...
_ata_detect:                                 ; 0xf2118 LB 0x68d
    ...
    je short 022eeh                           ; 74 08
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 022f0h                          ; eb 05
    jmp near 024ech                           ; e9 fe 01
    xor ax, ax                                ; 31 c0
    mov byte [bp-018h], al                    ; 88 46 e8
    mov byte [bp-016h], 000h                  ; c6 46 ea 00
    mov word [bp-030h], 00200h                ; c7 46 d0 00 02
    ...
    cmp word [bp-022h], 00fffh                ; 81 7e de ff 0f
    jne short 02349h                          ; 75 1e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 02349h                          ; 75 19
    ...
    jc short 0235ch                           ; 72 0c
    jbe short 02364h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0236ch                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 02368h                           ; 74 0e
    jmp short 023a6h                          ; eb 4a
    test al, al                               ; 84 c0
    jne short 023a6h                          ; 75 46
    mov BL, strict byte 01eh                  ; b3 1e
    jmp short 0236eh                          ; eb 0a
    mov BL, strict byte 026h                  ; b3 26
    jmp short 0236eh                          ; eb 06
    mov BL, strict byte 067h                  ; b3 67
    jmp short 0236eh                          ; eb 02
    mov BL, strict byte 070h                  ; b3 70
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 016ach                               ; e8 35 f3
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    mov al, bl                                ; 88 d8
    call 016ach                               ; e8 29 f3
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    ...
    call 05a41h                               ; e8 89 36
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 60 f5
    ...
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 002h                  ; 3c 02
    jnc short 024cch                          ; 73 73
    test al, al                               ; 84 c0
    jne short 02462h                          ; 75 05
    mov di, strict word 0003dh                ; bf 3d 00
    jmp short 02465h                          ; eb 03
    mov di, strict word 0004dh                ; bf 4d 00
    mov dx, word [bp-020h]                    ; 8b 56 e0
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    imul bx, ax, strict byte 00005h           ; 6b d8 05
    ...
    xor al, al                                ; 30 c0
    xor ah, ah                                ; 30 e4
    jmp short 024bdh                          ; eb 05
    cmp ah, 00fh                              ; 80 fc 0f
    jnc short 024ceh                          ; 73 11
    mov bl, ah                                ; 88 e3
    xor bh, bh                                ; 30 ff
    mov es, dx                                ; 8e c2
    add bx, di                                ; 01 fb
    ...
    db  0feh, 0c4h
    ; inc ah                                    ; fe c4
    jmp short 024b8h                          ; eb ec
    jmp short 024d6h                          ; eb 08
    neg al                                    ; f6 d8
    mov es, dx                                ; 8e c2
    ...
    mov ax, word [bp-01ch]                    ; 8b 46 e4
    mov dx, es                                ; 8c c2
    call 01e63h                               ; e8 33 f9
    test ax, ax                               ; 85 c0
    je short 0253fh                           ; 74 0b
    push 00174h                               ; 68 74 01
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 2a f4
    add sp, strict byte 00004h                ; 83 c4 04
    mov bl, byte [bp-00263h]                  ; 8a 9e 9d fd
    and bl, 01fh                              ; 80 e3 1f
    test byte [bp-00264h], 080h               ; f6 86 9c fd 80
    je short 02554h                           ; 74 07
    mov dx, strict word 00001h                ; ba 01 00
    jmp short 02556h                          ; eb 04
    jmp short 0258ch                          ; eb 38
    xor dx, dx                                ; 31 d2
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    ...
    mov di, word [bp-01ch]                    ; 8b 7e e4
    add di, ax                                ; 01 c7
    mov byte [es:di+023h], bl                 ; 26 88 5d 23
    mov byte [es:di+024h], dl                 ; 26 88 55 24
    mov byte [es:di+026h], 000h               ; 26 c6 45 26 00
    ...
    cmp AL, strict byte 003h                  ; 3c 03
    je short 025c3h                           ; 74 30
    cmp AL, strict byte 002h                  ; 3c 02
    jne short 025f3h                          ; 75 5c
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-02eh]                         ; 8e 46 d2
    ...
    jmp short 025e3h                          ; eb 09
    dec byte [bp-00ch]                        ; fe 4e f4
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jbe short 025efh                          ; 76 0c
    mov cl, byte [bp-00ch]                    ; 8a 4e f4
    mov dx, strict word 00001h                ; ba 01 00
    sal dx, CL                                ; d3 e2
    test ax, dx                               ; 85 d0
    je short 025dah                           ; 74 eb
    xor di, di                                ; 31 ff
    jmp short 025fah                          ; eb 07
    jmp short 02629h                          ; eb 34
    cmp di, strict byte 00014h                ; 83 ff 14
    jnl short 0260fh                          ; 7d 15
    mov si, di                                ; 89 fe
    add si, di                                ; 01 fe
    ...
    inc di                                    ; 47
    jmp short 025f5h                          ; eb e6
    mov byte [bp-03ch], 000h                  ; c6 46 c4 00
    mov di, strict word 00027h                ; bf 27 00
    jmp short 0261dh                          ; eb 05
    dec di                                    ; 4f
    test di, di                               ; 85 ff
    jle short 02629h                          ; 7e 0c
    cmp byte [bp+di-064h], 020h               ; 80 7b 9c 20
    jne short 02629h                          ; 75 06
    mov byte [bp+di-064h], 000h               ; c6 43 9c 00
    jmp short 02618h                          ; eb ef
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0268dh                           ; 74 5d
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0263bh                           ; 74 07
    cmp AL, strict byte 001h                  ; 3c 01
    je short 02698h                           ; 74 60
    jmp near 0271ch                           ; e9 e1 00
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    ...
    inc di                                    ; 47
    test ax, ax                               ; 85 c0
    je short 02675h                           ; 74 0e
    push ax                                   ; 50
    push 001b8h                               ; 68 b8 01
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 f6 f2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 0265dh                          ; eb e8
    ...
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 df f2
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 0271ch                           ; e9 8f 00
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 0269ah                           ; 74 07
    mov ax, 0019fh                            ; b8 9f 01
    jmp short 0269dh                          ; eb 05
    jmp short 026fch                          ; eb 62
    mov ax, 001a6h                            ; b8 a6 01
    push ax                                   ; 50
    mov al, byte [bp-012h]                    ; 8a 46 ee
    xor ah, ah                                ; 30 e4
    ...
    inc di                                    ; 47
    test ax, ax                               ; 85 c0
    je short 026c9h                           ; 74 0e
    push ax                                   ; 50
    push 001b8h                               ; 68 b8 01
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 a2 f2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 026b1h                          ; eb e8
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-02eh]                         ; 8e 46 d2
    mov bx, word [bp-01ch]                    ; 8b 5e e4
    ...
    jne short 026e9h                          ; 75 0b
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 001dbh                               ; 68 db 01
    jmp short 026f2h                          ; eb 09
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 001f5h                               ; 68 f5 01
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 6f f2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 0271ch                          ; eb 20
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 02707h                           ; 74 05
    mov ax, 0019fh                            ; b8 9f 01
    jmp short 0270ah                          ; eb 03
    mov ax, 001a6h                            ; b8 a6 01
    push ax                                   ; 50
    mov al, byte [bp-012h]                    ; 8a 46 ee
    xor ah, ah                                ; 30 e4
    ...
    jne short 02774h                          ; 75 03
    jmp near 0217ah                           ; e9 06 fa
    mov ax, 000b0h                            ; b8 b0 00
    jmp near 0217dh                           ; e9 03 fa
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov es, [bp-02eh]                         ; 8e 46 d2
    mov bx, word [bp-01ch]                    ; 8b 5e e4
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 c0 ee
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ata_cmd_data_out_:                           ; 0xf27a5 LB 0x28a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    je short 02804h                           ; 74 0f
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 02a28h                           ; e9 24 02
    ...
    mov ax, word [bp-014h]                    ; 8b 46 ec
    test ax, ax                               ; 85 c0
    je short 0284fh                           ; 74 03
    jmp near 02916h                           ; e9 c7 00
    xor bx, bx                                ; 31 db
    xor dx, dx                                ; 31 d2
    ...
    test dx, dx                               ; 85 d2
    jnbe short 02876h                         ; 77 10
    jne short 028d9h                          ; 75 71
    test ax, ax                               ; 85 c0
    jnbe short 02876h                         ; 77 0a
    jne short 028d9h                          ; 75 6b
    cmp bx, 01000h                            ; 81 fb 00 10
    jnbe short 02876h                         ; 77 02
    jne short 028d9h                          ; 75 63
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    mov bx, word [bp-00eh]                    ; 8b 5e f2
    mov cx, word [bp-010h]                    ; 8b 4e f0
    mov dx, word [bp-024h]                    ; 8b 56 dc
    mov si, strict word 00018h                ; be 18 00
    call 0a110h                               ; e8 88 78
    xor dh, dh                                ; 30 f6
    mov word [bp-014h], dx                    ; 89 56 ec
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    mov bx, word [bp-00eh]                    ; 8b 5e f2
    ...
    out DX, AL                                ; ee
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 02958h                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 0295bh                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    ...
    mov bl, al                                ; 88 c3
    test AL, strict byte 080h                 ; a8 80
    jne short 02973h                          ; 75 f1
    test AL, strict byte 001h                 ; a8 01
    je short 02995h                           ; 74 0f
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00002h                ; b8 02 00
    jmp near 02a28h                           ; e9 93 00
    test bl, 008h                             ; f6 c3 08
    jne short 029a9h                          ; 75 0f
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00003h                ; b8 03 00
    jmp near 02a28h                           ; e9 7f 00
    sti                                       ; fb
    mov ax, word [bp-016h]                    ; 8b 46 ea
    cmp ax, 0f800h                            ; 3d 00 f8
    jc short 029c2h                           ; 72 10
    ...
    mov bl, al                                ; 88 c3
    test AL, strict byte 080h                 ; a8 80
    jne short 029deh                          ; 75 f1
    cmp word [bp-022h], strict byte 00000h    ; 83 7e de 00
    jne short 02a07h                          ; 75 14
    and AL, strict byte 0e9h                  ; 24 e9
    cmp AL, strict byte 040h                  ; 3c 40
    je short 02a1dh                           ; 74 24
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00006h                ; b8 06 00
    jmp short 02a28h                          ; eb 21
    mov al, bl                                ; 88 d8
    and AL, strict byte 0c9h                  ; 24 c9
    cmp AL, strict byte 048h                  ; 3c 48
    je short 029aah                           ; 74 9b
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00007h                ; b8 07 00
    jmp short 02a28h                          ; eb 0b
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ata_read_sectors:                           ; 0xf2a2f LB 0xb5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, si                                ; 89 f0
    mov dx, es                                ; 8c c2
    call 01e63h                               ; e8 f8 f3
    mov es, [bp-00ch]                         ; 8e 46 f4
    jmp short 02ad5h                          ; eb 65
    xor bx, bx                                ; 31 db
    ...
    test di, di                               ; 85 ff
    jnbe short 02aach                         ; 77 11
    jne short 02ab8h                          ; 75 1b
    test bx, bx                               ; 85 db
    jnbe short 02aach                         ; 77 0b
    jne short 02ab8h                          ; 75 15
    cmp word [bp-008h], 01000h                ; 81 7e f8 00 10
    jnbe short 02aach                         ; 77 02
    jne short 02ab8h                          ; 75 0c
    mov bx, strict word 00024h                ; bb 24 00
    mov ax, si                                ; 89 f0
    mov dx, es                                ; 8c c2
    call 01e63h                               ; e8 ad f3
    jmp short 02adbh                          ; eb 23
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
...
@ata_write_sectors:                          ; 0xf2ae4 LB 0x5b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov cx, word [es:si+00eh]                 ; 26 8b 4c 0e
    cmp word [es:si+016h], strict byte 00000h ; 26 83 7c 16 00
    je short 02b04h                           ; 74 0c
    mov bx, strict word 00030h                ; bb 30 00
    mov ax, si                                ; 89 f0
    mov dx, es                                ; 8c c2
    call 027a5h                               ; e8 a3 fc
    jmp short 02b36h                          ; eb 32
    xor ax, ax                                ; 31 c0
    xor bx, bx                                ; 31 db
    xor dx, dx                                ; 31 d2
    mov di, word [es:si]                      ; 26 8b 3c
    ...
    test dx, dx                               ; 85 d2
    jnbe short 02b31h                         ; 77 0f
    jne short 02af8h                          ; 75 d4
    test bx, bx                               ; 85 db
    jnbe short 02b31h                         ; 77 09
    jne short 02af8h                          ; 75 ce
    cmp ax, 01000h                            ; 3d 00 10
    jnbe short 02b31h                         ; 77 02
    jne short 02af8h                          ; 75 c7
    mov bx, strict word 00034h                ; bb 34 00
    jmp short 02afbh                          ; eb c5
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
ata_cmd_packet_:                             ; 0xf2b3f LB 0x289
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 02b91h                          ; 75 1f
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 a6 ed
    push 00221h                               ; 68 21 02
    push 00230h                               ; 68 30 02
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 de ed
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 02dbfh                           ; e9 2e 02
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 02b8bh                          ; 75 f4
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 00006h           ; 6b c0 06
    mov es, [bp-012h]                         ; 8e 46 ee
    mov bx, word [bp-010h]                    ; 8b 5e f0
    ...
    jnc short 02bc9h                          ; 73 06
    mov byte [bp-006h], 00ch                  ; c6 46 fa 0c
    jmp short 02bcfh                          ; eb 06
    jbe short 02bcfh                          ; 76 04
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    je short 02bfdh                           ; 74 06
    mov ax, strict word 00002h                ; b8 02 00
    jmp near 02dbfh                           ; e9 c2 01
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 00ah                  ; b0 0a
    out DX, AL                                ; ee
    ...
    je short 02c23h                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 02c26h                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    add dx, strict byte 00006h                ; 83 c2 06
    out DX, AL                                ; ee
    ...
    mov bx, ax                                ; 89 c3
    test AL, strict byte 080h                 ; a8 80
    jne short 02c36h                          ; 75 f1
    test AL, strict byte 001h                 ; a8 01
    je short 02c58h                           ; 74 0f
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00003h                ; b8 03 00
    jmp near 02dbfh                           ; e9 67 01
    test AL, strict byte 008h                 ; a8 08
    jne short 02c6bh                          ; 75 0f
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00004h                ; b8 04 00
    jmp near 02dbfh                           ; e9 54 01
    sti                                       ; fb
    mov ax, si                                ; 89 f0
    ...
    jne short 02c92h                          ; 75 09
    add dx, strict byte 00007h                ; 83 c2 07
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp near 02da2h                           ; e9 10 01
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    add dx, strict byte 00007h                ; 83 c2 07
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov bx, ax                                ; 89 c3
    test AL, strict byte 080h                 ; a8 80
    jne short 02c92h                          ; 75 f1
    test AL, strict byte 088h                 ; a8 88
    je short 02d05h                           ; 74 60
    test AL, strict byte 001h                 ; a8 01
    je short 02cb4h                           ; 74 0b
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    jmp short 02c52h                          ; eb 9e
    and AL, strict byte 0c9h                  ; 24 c9
    cmp AL, strict byte 048h                  ; 3c 48
    je short 02cc5h                           ; 74 0b
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    jmp short 02c65h                          ; eb a0
    ...
    je short 02d59h                           ; 74 10
    inc bx                                    ; 43
    cmp word [bp-00ch], strict byte 00000h    ; 83 7e f4 00
    jbe short 02d59h                          ; 76 09
    test byte [bp-00ch], 001h                 ; f6 46 f4 01
    je short 02d59h                           ; 74 03
    dec word [bp-00ch]                        ; ff 4e f4
    shr bx, 1                                 ; d1 eb
    shr cx, 1                                 ; d1 e9
    shr word [bp-00ch], 1                     ; d1 6e f4
    test cx, cx                               ; 85 c9
    je short 02d6ah                           ; 74 06
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    in ax, DX                                 ; ed
    loop 02d67h                               ; e2 fd
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    ...
    jmp near 02c92h                           ; e9 f0 fe
    and AL, strict byte 0e9h                  ; 24 e9
    cmp AL, strict byte 040h                  ; 3c 40
    je short 02db4h                           ; 74 0c
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    jmp near 02c65h                           ; e9 b1 fe
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
...
ata_soft_reset_:                             ; 0xf2dc8 LB 0x80
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    out DX, AL                                ; ee
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    je short 02e0ah                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 02e0dh                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    mov dx, cx                                ; 89 ca
    add dx, strict byte 00006h                ; 83 c2 06
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    jne short 02e1bh                          ; 75 f4
    and AL, strict byte 0e9h                  ; 24 e9
    cmp AL, strict byte 040h                  ; 3c 40
    je short 02e38h                           ; 74 0b
    lea dx, [bx+006h]                         ; 8d 57 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 02e40h                          ; eb 08
    lea dx, [bx+006h]                         ; 8d 57 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    xor ax, ax                                ; 31 c0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_diskette_current_cyl_:                   ; 0xf2e48 LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov dh, al                                ; 88 c6
    cmp AL, strict byte 001h                  ; 3c 01
    jbe short 02e5dh                          ; 76 0b
    push 00250h                               ; 68 50 02
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 0c eb
    add sp, strict byte 00004h                ; 83 c4 04
    mov bl, dh                                ; 88 f3
    xor bh, bh                                ; 30 ff
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_wait_for_interrupt_:                  ; 0xf2e73 LB 0x23
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    cli                                       ; fa
    ...
    mov al, byte [es:bx]                      ; 26 8a 07
    test AL, strict byte 080h                 ; a8 80
    je short 02e8bh                           ; 74 04
    and AL, strict byte 080h                  ; 24 80
    jmp short 02e90h                          ; eb 05
    sti                                       ; fb
    hlt                                       ; f4
    cli                                       ; fa
    jmp short 02e78h                          ; eb e8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_wait_for_interrupt_or_timeout_:       ; 0xf2e96 LB 0x38
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    cli                                       ; fa
    ...
    mov al, byte [es:bx]                      ; 26 8a 07
    test al, al                               ; 84 c0
    jne short 02eaah                          ; 75 03
    sti                                       ; fb
    jmp short 02ec8h                          ; eb 1e
    mov bx, strict word 0003eh                ; bb 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:bx]                      ; 26 8a 07
    test AL, strict byte 080h                 ; a8 80
    je short 02ec3h                           ; 74 0a
    mov ah, al                                ; 88 c4
    and ah, 07fh                              ; 80 e4 7f
    mov byte [es:bx], ah                      ; 26 88 27
    jmp short 02ec8h                          ; eb 05
    sti                                       ; fb
    hlt                                       ; f4
    cli                                       ; fa
    jmp short 02e9bh                          ; eb d3
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_reset_controller_:                    ; 0xf2ece LB 0x3f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_prepare_controller_:                  ; 0xf2f0d LB 0x74
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov byte [bp-008h], al                    ; 88 46 f8
    test cx, cx                               ; 85 c9
    je short 02f39h                           ; 74 04
    mov AL, strict byte 020h                  ; b0 20
    jmp short 02f3bh                          ; eb 02
    ...
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jne short 02f79h                          ; 75 0e
    call 02e73h                               ; e8 05 ff
    mov bx, strict word 0003eh                ; bb 3e 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_media_known_:                         ; 0xf2f81 LB 0x49
    push bx                                   ; 53
    push dx                                   ; 52
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    mov bl, bh                                ; 88 fb
    test ax, ax                               ; 85 c0
    je short 02f99h                           ; 74 02
    shr bl, 1                                 ; d0 eb
    and bl, 001h                              ; 80 e3 01
    jne short 02fa2h                          ; 75 04
    xor bh, bh                                ; 30 ff
    jmp short 02fc4h                          ; eb 22
    mov bx, 00090h                            ; bb 90 00
    test ax, ax                               ; 85 c0
    je short 02fach                           ; 74 03
    ...
    jne short 02fc1h                          ; 75 04
    xor bx, bx                                ; 31 db
    jmp short 02fc4h                          ; eb 03
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
floppy_read_id_:                             ; 0xf2fca LB 0x52
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    inc bx                                    ; 43
    jmp short 02fe5h                          ; eb e7
    mov bx, strict word 00042h                ; bb 42 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:bx]                      ; 26 8a 07
    test AL, strict byte 0c0h                 ; a8 c0
    je short 03011h                           ; 74 04
    xor ax, ax                                ; 31 c0
    jmp short 03014h                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_drive_recal_:                         ; 0xf301c LB 0x41
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    push si                                   ; 56
    mov bx, ax                                ; 89 c3
    call 02f0dh                               ; e8 e6 fe
    mov AL, strict byte 007h                  ; b0 07
    mov dx, 003f5h                            ; ba f5 03
    out DX, AL                                ; ee
    mov al, bl                                ; 88 d8
    out DX, AL                                ; ee
    call 02e73h                               ; e8 40 fe
    test bx, bx                               ; 85 db
    je short 0303eh                           ; 74 07
    or AL, strict byte 002h                   ; 0c 02
    mov bx, 00095h                            ; bb 95 00
    jmp short 03043h                          ; eb 05
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_media_sense_:                         ; 0xf305d LB 0xe6
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    push di                                   ; 57
    mov cx, ax                                ; 89 c1
    call 0301ch                               ; e8 b2 ff
    test ax, ax                               ; 85 c0
    jne short 03073h                          ; 75 05
    xor dx, dx                                ; 31 d2
    jmp near 03137h                           ; e9 c4 00
    mov ax, strict word 00010h                ; b8 10 00
    call 016ach                               ; e8 33 e6
    test cx, cx                               ; 85 c9
    jne short 03084h                          ; 75 07
    mov dl, al                                ; 88 c2
    shr dl, 004h                              ; c0 ea 04
    jmp short 03089h                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    cmp dl, 001h                              ; 80 fa 01
    jne short 03097h                          ; 75 09
    xor dl, dl                                ; 30 d2
    mov DH, strict byte 015h                  ; b6 15
    mov bx, strict word 00001h                ; bb 01 00
    jmp short 030d5h                          ; eb 3e
    cmp dl, 002h                              ; 80 fa 02
    jne short 030a2h                          ; 75 06
    xor dl, dl                                ; 30 d2
    mov DH, strict byte 035h                  ; b6 35
    jmp short 03092h                          ; eb f0
    cmp dl, 003h                              ; 80 fa 03
    jne short 030adh                          ; 75 06
    xor dl, dl                                ; 30 d2
    mov DH, strict byte 017h                  ; b6 17
    jmp short 03092h                          ; eb e5
    cmp dl, 004h                              ; 80 fa 04
    jne short 030b8h                          ; 75 06
    xor dl, dl                                ; 30 d2
    mov DH, strict byte 017h                  ; b6 17
    jmp short 03092h                          ; eb da
    cmp dl, 005h                              ; 80 fa 05
    jne short 030c3h                          ; 75 06
    mov DL, strict byte 0cch                  ; b2 cc
    mov DH, strict byte 0d7h                  ; b6 d7
    jmp short 03092h                          ; eb cf
    cmp dl, 00eh                              ; 80 fa 0e
    je short 030cdh                           ; 74 05
    cmp dl, 00fh                              ; 80 fa 0f
    jne short 030cfh                          ; 75 02
    jmp short 030bdh                          ; eb ee
    xor dl, dl                                ; 30 d2
    xor dh, dh                                ; 30 f6
    xor bx, bx                                ; 31 db
    ...
    mov ax, cx                                ; 89 c8
    call 02fcah                               ; e8 e5 fe
    test ax, ax                               ; 85 c0
    jne short 0311bh                          ; 75 32
    mov al, dl                                ; 88 d0
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 080h                  ; 3c 80
    je short 0311bh                           ; 74 2a
    mov al, dl                                ; 88 d0
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 03108h                           ; 74 0f
    mov ah, dl                                ; 88 d4
    and ah, 03fh                              ; 80 e4 3f
    cmp AL, strict byte 040h                  ; 3c 40
    je short 03114h                           ; 74 12
    test al, al                               ; 84 c0
    je short 0310dh                           ; 74 07
    jmp short 030d5h                          ; eb cd
    and dl, 03fh                              ; 80 e2 3f
    jmp short 030d5h                          ; eb c8
    mov dl, ah                                ; 88 e2
    or dl, 040h                               ; 80 ca 40
    jmp short 030d5h                          ; eb c1
    mov dl, ah                                ; 88 e2
    or dl, 080h                               ; 80 ca 80
    jmp short 030d5h                          ; eb ba
    test cx, cx                               ; 85 c9
    jne short 03124h                          ; 75 05
    mov si, 00090h                            ; be 90 00
    jmp short 03127h                          ; eb 03
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_drive_exists_:                        ; 0xf3143 LB 0x4b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, ax                                ; 89 c2
    mov ax, strict word 00010h                ; b8 10 00
    call 016ach                               ; e8 5d e5
    test dx, dx                               ; 85 d2
    jne short 03158h                          ; 75 05
    shr al, 004h                              ; c0 e8 04
    jmp short 0315ah                          ; eb 02
    and AL, strict byte 00fh                  ; 24 0f
    test al, al                               ; 84 c0
    je short 03163h                           ; 74 05
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 03165h                          ; eb 02
    xor ah, ah                                ; 30 e4
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    ...
    ; ss in AL, DX                              ; 36 ec
    aaa                                       ; 37
    fidivr dword [bx+si]                      ; da 38
    sbb AL, strict byte 039h                  ; 1c 39
    push ax                                   ; 50
    cmp sp, ax                                ; 39 c4
    db  039h
_int13_diskette_function:                    ; 0xf318e LB 0x9ce
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    jnbe short 031ffh                         ; 77 5c
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0000ch                ; b9 0c 00
    mov di, 0316bh                            ; bf 6b 31
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov di, word [cs:di+03176h]               ; 2e 8b bd 76 31
    ...
    jmp near 03a26h                           ; e9 38 08
    mov ax, strict word 00010h                ; b8 10 00
    call 016ach                               ; e8 b8 e4
    test bl, bl                               ; 84 db
    jne short 03202h                          ; 75 0a
    mov dl, al                                ; 88 c2
    shr dl, 004h                              ; c0 ea 04
    jmp short 03207h                          ; eb 08
    jmp near 03b39h                           ; e9 37 09
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    test dl, dl                               ; 84 d2
    jne short 03225h                          ; 75 1a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    test bl, bl                               ; 84 db
    je short 03249h                           ; 74 de
    jmp near 03a26h                           ; e9 b8 07
    ...
    mov bl, byte [bp+00eh]                    ; 8a 5e 0e
    cmp bl, 001h                              ; 80 fb 01
    jnbe short 0329eh                         ; 77 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jnbe short 0329eh                         ; 77 09
    test bh, bh                               ; 84 ff
    je short 0329eh                           ; 74 05
    cmp bh, 048h                              ; 80 ff 48
    jbe short 032d1h                          ; 76 33
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 7a e6
    push 00275h                               ; 68 75 02
    push 0028dh                               ; 68 8d 02
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 b2 e6
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 001h                    ; 26 c6 07 01
    jmp near 0337bh                           ; e9 aa 00
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 03143h                               ; e8 6b fe
    test ax, ax                               ; 85 c0
    jne short 032f6h                          ; 75 1a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 080h                    ; 26 c6 07 80
    jmp near 0337bh                           ; e9 85 00
    mov cl, bl                                ; 88 d9
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 02f81h                               ; e8 82 fc
    test ax, ax                               ; 85 c0
    jne short 03329h                          ; 75 26
    mov ax, cx                                ; 89 c8
    call 0305dh                               ; e8 55 fd
    test ax, ax                               ; 85 c0
    jne short 03329h                          ; 75 1d
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    jmp near 03a26h                           ; e9 fd 06
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00002h                ; 3d 02 00
    jne short 03382h                          ; 75 4e
    ...
    jmp near 03a26h                           ; e9 a4 06
    jmp near 034d2h                           ; e9 4d 01
    ...
    mov AL, strict byte 0ffh                  ; b0 ff
    out DX, AL                                ; ee
    call 02e96h                               ; e8 85 fa
    test al, al                               ; 84 c0
    jne short 03434h                          ; 75 1f
    mov ax, cx                                ; 89 c8
    call 02eceh                               ; e8 b4 fa
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 0344eh                           ; 74 0e
    push 00275h                               ; 68 75 02
    push 002a8h                               ; 68 a8 02
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 1b e5
    add sp, strict byte 00006h                ; 83 c4 06
    xor cx, cx                                ; 31 c9
    jmp short 03457h                          ; eb 05
    cmp cx, strict byte 00007h                ; 83 f9 07
    jnl short 0346dh                          ; 7d 16
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [es:si], al                      ; 26 88 04
    inc cx                                    ; 41
    jmp short 03452h                          ; eb e5
    mov si, strict word 00042h                ; be 42 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 0c0h                 ; a8 c0
    je short 0349dh                           ; 74 21
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 02eceh                               ; e8 4b fa
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 020h                               ; 80 cc 20
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 02e48h                               ; e8 81 f9
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp near 03249h                           ; e9 77 fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 034e0h                           ; 74 03
    jmp near 0360bh                           ; e9 2b 01
    mov cx, word [bp+006h]                    ; 8b 4e 06
    ...
    add dx, cx                                ; 01 ca
    cmp dx, word [bp-008h]                    ; 3b 56 f8
    jnc short 03513h                          ; 73 03
    jmp near 03364h                           ; e9 51 fe
    mov AL, strict byte 006h                  ; b0 06
    mov dx, strict word 0000ah                ; ba 0a 00
    out DX, AL                                ; ee
    xor al, al                                ; 30 c0
    ...
    mov AL, strict byte 0ffh                  ; b0 ff
    out DX, AL                                ; ee
    call 02e96h                               ; e8 f7 f8
    test al, al                               ; 84 c0
    jne short 035a6h                          ; 75 03
    jmp near 03415h                           ; e9 6f fe
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 035c0h                           ; 74 0e
    push 00275h                               ; 68 75 02
    push 002a8h                               ; 68 a8 02
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 a9 e3
    add sp, strict byte 00006h                ; 83 c4 06
    xor cx, cx                                ; 31 c9
    jmp short 035c9h                          ; eb 05
    cmp cx, strict byte 00007h                ; 83 f9 07
    jnl short 035dfh                          ; 7d 16
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [es:si], al                      ; 26 88 04
    inc cx                                    ; 41
    jmp short 035c4h                          ; eb e5
    mov si, strict word 00042h                ; be 42 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 0c0h                 ; a8 c0
    jne short 035f1h                          ; 75 03
    jmp near 034bbh                           ; e9 ca fe
    mov bx, strict word 00043h                ; bb 43 00
    mov al, byte [es:bx]                      ; 26 8a 07
    test AL, strict byte 002h                 ; a8 02
    je short 03603h                           ; 74 08
    mov word [bp+016h], 00300h                ; c7 46 16 00 03
    jmp near 03a26h                           ; e9 23 04
    mov word [bp+016h], 00100h                ; c7 46 16 00 01
    jmp near 03a26h                           ; e9 1b 04
    mov dl, byte [bp-004h]                    ; 8a 56 fc
    xor dh, dh                                ; 30 f6
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 02e48h                               ; e8 31 f8
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    jmp near 03249h                           ; e9 27 fc
    mov bh, byte [bp+016h]                    ; 8a 7e 16
    mov ax, word [bp+014h]                    ; 8b 46 14
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-004h], al                    ; 88 46 fc
    ...
    mov bl, byte [bp+00eh]                    ; 8a 5e 0e
    cmp bl, 001h                              ; 80 fb 01
    jnbe short 03651h                         ; 77 12
    cmp dl, 001h                              ; 80 fa 01
    jnbe short 03651h                         ; 77 0d
    cmp AL, strict byte 04fh                  ; 3c 4f
    jnbe short 03651h                         ; 77 09
    test bh, bh                               ; 84 ff
    je short 03651h                           ; 74 05
    cmp bh, 012h                              ; 80 ff 12
    jbe short 0366ch                          ; 76 1b
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 03143h                               ; e8 d0 fa
    test ax, ax                               ; 85 c0
    jne short 03691h                          ; 75 1a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 080h                    ; 26 c6 07 80
    jmp near 03a26h                           ; e9 95 03
    mov cl, bl                                ; 88 d9
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 02f81h                               ; e8 e7 f8
    test ax, ax                               ; 85 c0
    jne short 036aah                          ; 75 0c
    mov ax, cx                                ; 89 c8
    call 0305dh                               ; e8 ba f9
    test ax, ax                               ; 85 c0
    jne short 036aah                          ; 75 03
    jmp near 0330ch                           ; e9 62 fc
    mov cx, word [bp+006h]                    ; 8b 4e 06
    shr cx, 00ch                              ; c1 e9 0c
    mov ah, cl                                ; 88 cc
    mov dx, word [bp+006h]                    ; 8b 56 06
    ...
    add dx, cx                                ; 01 ca
    cmp dx, word [bp-008h]                    ; 3b 56 f8
    jnc short 036ddh                          ; 73 03
    jmp near 03364h                           ; e9 87 fc
    mov AL, strict byte 006h                  ; b0 06
    mov dx, strict word 0000ah                ; ba 0a 00
    out DX, AL                                ; ee
    xor al, al                                ; 30 c0
    ...
    out DX, AL                                ; ee
    call 02e96h                               ; e8 35 f7
    test al, al                               ; 84 c0
    jne short 0376dh                          ; 75 08
    mov ax, cx                                ; 89 c8
    call 02eceh                               ; e8 64 f7
    jmp near 03677h                           ; e9 0a ff
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 03787h                           ; 74 0e
    push 00275h                               ; 68 75 02
    push 002a8h                               ; 68 a8 02
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 e2 e1
    add sp, strict byte 00006h                ; 83 c4 06
    xor cx, cx                                ; 31 c9
    jmp short 03790h                          ; eb 05
    cmp cx, strict byte 00007h                ; 83 f9 07
    jnl short 037a6h                          ; 7d 16
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [es:si], al                      ; 26 88 04
    inc cx                                    ; 41
    jmp short 0378bh                          ; eb e5
    mov si, strict word 00042h                ; be 42 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 0c0h                 ; a8 c0
    je short 037d0h                           ; 74 1b
    mov si, strict word 00043h                ; be 43 00
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 002h                 ; a8 02
    je short 037c2h                           ; 74 03
    jmp near 035fbh                           ; e9 39 fe
    push 00275h                               ; 68 75 02
    push 002bch                               ; 68 bc 02
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 99 e1
    add sp, strict byte 00006h                ; 83 c4 06
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    mov si, strict word 00041h                ; be 41 00
    mov ax, strict word 00040h                ; b8 40 00
    ...
    xor ah, ah                                ; 30 e4
    xor dx, dx                                ; 31 d2
    call 02e48h                               ; e8 5f f6
    jmp near 034cbh                           ; e9 df fc
    mov bl, ah                                ; 88 e3
    cmp ah, 001h                              ; 80 fc 01
    jbe short 03811h                          ; 76 1e
    xor ax, ax                                ; 31 c0
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    xor ah, ah                                ; 30 e4
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 03930h                           ; e9 1f 01
    mov ax, strict word 00010h                ; b8 10 00
    call 016ach                               ; e8 95 de
    mov dl, al                                ; 88 c2
    xor bh, bh                                ; 30 ff
    test AL, strict byte 0f0h                 ; a8 f0
    je short 03821h                           ; 74 02
    mov BH, strict byte 001h                  ; b7 01
    test dl, 00fh                             ; f6 c2 0f
    je short 03828h                           ; 74 02
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    test bl, bl                               ; 84 db
    jne short 03831h                          ; 75 05
    shr dl, 004h                              ; c0 ea 04
    jmp short 03834h                          ; eb 03
    and dl, 00fh                              ; 80 e2 0f
    ...
    mov word [bp+012h], ax                    ; 89 46 12
    cmp dl, 003h                              ; 80 fa 03
    jc short 03870h                           ; 72 15
    jbe short 03897h                          ; 76 3a
    cmp dl, 005h                              ; 80 fa 05
    jc short 0389eh                           ; 72 3c
    jbe short 038a5h                          ; 76 41
    cmp dl, 00fh                              ; 80 fa 0f
    je short 038b3h                           ; 74 4a
    cmp dl, 00eh                              ; 80 fa 0e
    je short 038ach                           ; 74 3e
    jmp short 038bah                          ; eb 4a
    cmp dl, 002h                              ; 80 fa 02
    je short 03890h                           ; 74 1b
    cmp dl, 001h                              ; 80 fa 01
    je short 03889h                           ; 74 0f
    test dl, dl                               ; 84 d2
    jne short 038bah                          ; 75 3c
    mov word [bp+014h], strict word 00000h    ; c7 46 14 00 00
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 038c8h                          ; eb 3f
    mov word [bp+014h], 02709h                ; c7 46 14 09 27
    jmp short 038c8h                          ; eb 38
    mov word [bp+014h], 04f0fh                ; c7 46 14 0f 4f
    jmp short 038c8h                          ; eb 31
    mov word [bp+014h], 04f09h                ; c7 46 14 09 4f
    jmp short 038c8h                          ; eb 2a
    mov word [bp+014h], 04f12h                ; c7 46 14 12 4f
    jmp short 038c8h                          ; eb 23
    mov word [bp+014h], 04f24h                ; c7 46 14 24 4f
    jmp short 038c8h                          ; eb 1c
    mov word [bp+014h], 0fe3fh                ; c7 46 14 3f fe
    jmp short 038c8h                          ; eb 15
    mov word [bp+014h], 0feffh                ; c7 46 14 ff fe
    jmp short 038c8h                          ; eb 0e
    push 00275h                               ; 68 75 02
    push 002cdh                               ; 68 cd 02
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 a1 e0
    add sp, strict byte 00006h                ; 83 c4 06
    mov word [bp+006h], 0f000h                ; c7 46 06 00 f0
    mov al, dl                                ; 88 d0
    xor ah, ah                                ; 30 e4
    call 03b5ch                               ; e8 88 02
    mov word [bp+008h], ax                    ; 89 46 08
    jmp near 034cbh                           ; e9 f1 fb
    mov bl, ah                                ; 88 e3
    cmp ah, 001h                              ; 80 fc 01
    jbe short 038e6h                          ; 76 05
    mov word [bp+016h], dx                    ; 89 56 16
    jmp short 03930h                          ; eb 4a
    mov ax, strict word 00010h                ; b8 10 00
    call 016ach                               ; e8 c0 dd
    test bl, bl                               ; 84 db
    jne short 038f7h                          ; 75 07
    mov dl, al                                ; 88 c2
    shr dl, 004h                              ; c0 ea 04
    jmp short 038fch                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    test dl, dl                               ; 84 d2
    je short 03916h                           ; 74 0d
    cmp dl, 001h                              ; 80 fa 01
    jbe short 03913h                          ; 76 05
    or ah, 002h                               ; 80 cc 02
    jmp short 03916h                          ; eb 03
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    jmp near 03249h                           ; e9 2d f9
    cmp ah, 001h                              ; 80 fc 01
    jbe short 03936h                          ; 76 15
    ...
    jmp near 03a26h                           ; e9 d6 00
    mov bl, ah                                ; 88 e3
    mov dl, byte [bp+016h]                    ; 8a 56 16
    cmp ah, 001h                              ; 80 fc 01
    jnbe short 03921h                         ; 77 c7
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 03143h                               ; e8 e2 f7
    test ax, ax                               ; 85 c0
    jne short 03968h                          ; 75 03
    jmp near 03677h                           ; e9 0f fd
    test bl, bl                               ; 84 db
    je short 03971h                           ; 74 05
    mov bx, 00091h                            ; bb 91 00
    jmp short 03974h                          ; eb 03
    mov bx, 00090h                            ; bb 90 00
    mov word [bp-008h], bx                    ; 89 5e f8
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    ...
    cmp dl, 002h                              ; 80 fa 02
    jc short 03996h                           ; 72 0f
    jbe short 039a3h                          ; 76 1a
    cmp dl, 004h                              ; 80 fa 04
    je short 0399eh                           ; 74 10
    cmp dl, 003h                              ; 80 fa 03
    je short 039a8h                           ; 74 15
    jmp near 031d4h                           ; e9 3e f8
    cmp dl, 001h                              ; 80 fa 01
    je short 0399eh                           ; 74 03
    jmp near 031d4h                           ; e9 36 f8
    or bl, 090h                               ; 80 cb 90
    jmp short 039abh                          ; eb 08
    or bl, 070h                               ; 80 cb 70
    jmp short 039abh                          ; eb 03
    or bl, 010h                               ; 80 cb 10
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    ...
    cmp ah, 001h                              ; 80 fc 01
    jbe short 039ebh                          ; 76 03
    jmp near 03921h                           ; e9 36 ff
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 03143h                               ; e8 51 f7
    test ax, ax                               ; 85 c0
    jne short 039f9h                          ; 75 03
    jmp near 03677h                           ; e9 7e fc
    mov cl, bl                                ; 88 d9
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 02f81h                               ; e8 7f f5
    test ax, ax                               ; 85 c0
    jne short 03a2dh                          ; 75 27
    mov ax, cx                                ; 89 c8
    call 0305dh                               ; e8 52 f6
    test ax, ax                               ; 85 c0
    jne short 03a2dh                          ; 75 1e
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov byte [es:bx], 00ch                    ; 26 c6 07 0c
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 03249h                           ; e9 1c f8
    mov ax, strict word 00010h                ; b8 10 00
    call 016ach                               ; e8 79 dc
    test bl, bl                               ; 84 db
    jne short 03a3eh                          ; 75 07
    mov dl, al                                ; 88 c2
    shr dl, 004h                              ; c0 ea 04
    jmp short 03a43h                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    test bl, bl                               ; 84 db
    je short 03a4ch                           ; 74 05
    mov si, 00091h                            ; be 91 00
    jmp short 03a4fh                          ; eb 03
    mov si, 00090h                            ; be 90 00
    mov word [bp-008h], si                    ; 89 76 f8
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    ...
    and bl, 00fh                              ; 80 e3 0f
    cmp dl, 003h                              ; 80 fa 03
    jc short 03a7dh                           ; 72 1b
    mov al, bl                                ; 88 d8
    or AL, strict byte 090h                   ; 0c 90
    cmp dl, 003h                              ; 80 fa 03
    jbe short 03ab9h                          ; 76 4e
    mov ah, bl                                ; 88 dc
    or ah, 010h                               ; 80 cc 10
    cmp dl, 005h                              ; 80 fa 05
    je short 03ab7h                           ; 74 42
    cmp dl, 004h                              ; 80 fa 04
    je short 03ac6h                           ; 74 4c
    jmp near 03afeh                           ; e9 81 00
    cmp dl, 002h                              ; 80 fa 02
    je short 03a97h                           ; 74 15
    cmp dl, 001h                              ; 80 fa 01
    jne short 03acah                          ; 75 43
    cmp byte [bp-004h], 027h                  ; 80 7e fc 27
    jne short 03acah                          ; 75 3d
    cmp bh, 009h                              ; 80 ff 09
    jne short 03ae0h                          ; 75 4e
    or bl, 090h                               ; 80 cb 90
    jmp short 03ae0h                          ; eb 49
    cmp byte [bp-004h], 027h                  ; 80 7e fc 27
    jne short 03aa7h                          ; 75 0a
    cmp bh, 009h                              ; 80 ff 09
    jne short 03aa7h                          ; 75 05
    or bl, 070h                               ; 80 cb 70
    jmp short 03ae0h                          ; eb 39
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03afeh                          ; 75 51
    cmp bh, 00fh                              ; 80 ff 0f
    jne short 03afeh                          ; 75 4c
    or bl, 010h                               ; 80 cb 10
    jmp short 03afeh                          ; eb 47
    jmp short 03ae2h                          ; eb 29
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03afeh                          ; 75 3f
    cmp bh, 009h                              ; 80 ff 09
    je short 03ac8h                           ; 74 04
    jmp short 03afeh                          ; eb 38
    jmp short 03acch                          ; eb 04
    mov bl, al                                ; 88 c3
    jmp short 03afeh                          ; eb 32
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03afeh                          ; 75 2c
    cmp bh, 009h                              ; 80 ff 09
    jne short 03ad9h                          ; 75 02
    jmp short 03ac8h                          ; eb ef
    cmp bh, 012h                              ; 80 ff 12
    jne short 03afeh                          ; 75 20
    mov bl, ah                                ; 88 e3
    jmp short 03afeh                          ; eb 1c
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03afeh                          ; 75 16
    cmp bh, 009h                              ; 80 ff 09
    jne short 03aefh                          ; 75 02
    jmp short 03ac8h                          ; eb d9
    cmp bh, 012h                              ; 80 ff 12
    jne short 03af6h                          ; 75 02
    jmp short 03adeh                          ; eb e8
    cmp bh, 024h                              ; 80 ff 24
    jne short 03afeh                          ; 75 03
    or bl, 0d0h                               ; 80 cb d0
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    sar ax, 004h                              ; c1 f8 04
    test AL, strict byte 001h                 ; a8 01
    jne short 03b0ch                          ; 75 03
    jmp near 03a0fh                           ; e9 03 ff
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov si, word [bp-008h]                    ; 8b 76 f8
    mov byte [es:si], bl                      ; 26 88 1c
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 000h                    ; 26 c6 07 00
    jmp near 034cbh                           ; e9 92 f9
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 df dd
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00275h                               ; 68 75 02
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 10 de
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 031d4h                           ; e9 78 f6
get_floppy_dpt_:                             ; 0xf3b5c LB 0x30
    push bx                                   ; 53
    push dx                                   ; 52
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
...
_cdemu_init:                                 ; 0xf3b93 LB 0x18
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_isactive:                             ; 0xf3bab LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 b5 da
    mov dx, 00366h                            ; ba 66 03
    call 01650h                               ; e8 93 da
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_emulated_drive:                       ; 0xf3bc1 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 9f da
    mov dx, 00368h                            ; ba 68 03
    call 01650h                               ; e8 7d da
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_int13_eltorito:                             ; 0xf3bd7 LB 0x190
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 0165eh                               ; e8 59 d9
    test byte [bp+016h], 0ffh                 ; f6 46 16 ff
    jne short 03d11h                          ; 75 06
    mov es, di                                ; 8e c7
    mov byte [es:si], 000h                    ; 26 c6 04 00
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 ed db
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 002fch                               ; 68 fc 02
    push 00333h                               ; 68 33 03
    jmp near 03c18h                           ; e9 d2 fe
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 fd d8
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 03d24h                          ; eb bd
device_is_cdrom_:                            ; 0xf3d67 LB 0x35
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 f5 d8
    cmp bl, 010h                              ; 80 fb 10
    jc short 03d80h                           ; 72 04
    xor ax, ax                                ; 31 c0
    jmp short 03d95h                          ; eb 15
    xor bh, bh                                ; 30 ff
    imul bx, bx, strict byte 0001ch           ; 6b db 1c
    mov es, ax                                ; 8e c0
    add bx, 00122h                            ; 81 c3 22 01
    cmp byte [es:bx+023h], 005h               ; 26 80 7f 23 05
    jne short 03d7ch                          ; 75 ea
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop dx                                    ; 5a
    pop bx                                    ; 5b
...
cdrom_boot_:                                 ; 0xf3d9c LB 0x435
    ...
    jmp short 03dd1h                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 010h                  ; 80 7e f4 10
    jnc short 03dddh                          ; 73 0c
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    call 03d67h                               ; e8 8e ff
    test ax, ax                               ; 85 c0
    je short 03dc8h                           ; 74 eb
    cmp byte [bp-00ch], 010h                  ; 80 7e f4 10
    jc short 03de9h                           ; 72 06
    mov ax, strict word 00002h                ; b8 02 00
    jmp near 0416eh                           ; e9 85 03
    mov cx, strict word 0000ch                ; b9 0c 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 0a130h                               ; e8 3a 63
    ...
    test ax, ax                               ; 85 c0
    jne short 03e2bh                          ; 75 bb
    test ax, ax                               ; 85 c0
    je short 03e7ah                           ; 74 06
    mov ax, strict word 00003h                ; b8 03 00
    jmp near 0416eh                           ; e9 f4 02
    cmp byte [bp-00826h], 000h                ; 80 be da f7 00
    je short 03e87h                           ; 74 06
    mov ax, strict word 00004h                ; b8 04 00
    jmp near 0416eh                           ; e9 e7 02
    xor di, di                                ; 31 ff
    jmp short 03e91h                          ; eb 06
    inc di                                    ; 47
    cmp di, strict byte 00005h                ; 83 ff 05
    jnc short 03ea1h                          ; 73 10
    mov al, byte [bp+di-00825h]               ; 8a 83 db f7
    cmp al, byte [di+00da8h]                  ; 3a 85 a8 0d
    je short 03e8bh                           ; 74 f0
    mov ax, strict word 00005h                ; b8 05 00
    jmp near 0416eh                           ; e9 cd 02
    xor di, di                                ; 31 ff
    jmp short 03eabh                          ; eb 06
    inc di                                    ; 47
    cmp di, strict byte 00017h                ; 83 ff 17
    jnc short 03ebbh                          ; 73 10
    mov al, byte [bp+di-0081fh]               ; 8a 83 e1 f7
    cmp al, byte [di+00daeh]                  ; 3a 85 ae 0d
    je short 03ea5h                           ; 74 f0
    mov ax, strict word 00006h                ; b8 06 00
    jmp near 0416eh                           ; e9 b3 02
    ...
    call word [word di+0006ah]                ; ff 95 6a 00
    test ax, ax                               ; 85 c0
    je short 03f1dh                           ; 74 06
    mov ax, strict word 00007h                ; b8 07 00
    jmp near 0416eh                           ; e9 51 02
    cmp byte [bp-00826h], 001h                ; 80 be da f7 01
    je short 03f2ah                           ; 74 06
    mov ax, strict word 00008h                ; b8 08 00
    jmp near 0416eh                           ; e9 44 02
    cmp byte [bp-00825h], 000h                ; 80 be db f7 00
    je short 03f37h                           ; 74 06
    mov ax, strict word 00009h                ; b8 09 00
    jmp near 0416eh                           ; e9 37 02
    cmp byte [bp-00808h], 055h                ; 80 be f8 f7 55
    je short 03f44h                           ; 74 06
    mov ax, strict word 0000ah                ; b8 0a 00
    jmp near 0416eh                           ; e9 2a 02
    cmp byte [bp-00807h], 0aah                ; 80 be f9 f7 aa
    jne short 03f3eh                          ; 75 f3
    cmp byte [bp-00806h], 088h                ; 80 be fa f7 88
    je short 03f58h                           ; 74 06
    mov ax, strict word 0000bh                ; b8 0b 00
    jmp near 0416eh                           ; e9 16 02
    ...
    test di, di                               ; 85 ff
    je short 03fd5h                           ; 74 06
    cmp di, 00400h                            ; 81 ff 00 04
    jbe short 03fdbh                          ; 76 06
    mov ax, strict word 0000ch                ; b8 0c 00
    jmp near 0416eh                           ; e9 93 01
    ...
    test ax, ax                               ; 85 c0
    je short 04083h                           ; 74 06
    mov ax, strict word 0000dh                ; b8 0d 00
    jmp near 0416eh                           ; e9 eb 00
    mov es, [bp-014h]                         ; 8e 46 ec
    mov al, byte [es:si+001h]                 ; 26 8a 44 01
    cmp AL, strict byte 002h                  ; 3c 02
    jc short 0409bh                           ; 72 0d
    jbe short 040b6h                          ; 76 26
    cmp AL, strict byte 004h                  ; 3c 04
    je short 040c6h                           ; 74 32
    cmp AL, strict byte 003h                  ; 3c 03
    je short 040beh                           ; 74 26
    jmp near 04113h                           ; e9 78 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 04113h                          ; 75 74
    mov es, [bp-014h]                         ; 8e 46 ec
    ...
    je short 04154h                           ; 74 37
    cmp byte [es:si+002h], 000h               ; 26 80 7c 02 00
    jne short 0413ch                          ; 75 18
    mov dx, strict word 00010h                ; ba 10 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 23 d5
    mov bl, al                                ; 88 c3
    or bl, 041h                               ; 80 cb 41
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00010h                ; ba 10 00
    mov ax, strict word 00040h                ; b8 40 00
    jmp short 04151h                          ; eb 15
    mov dx, 00304h                            ; ba 04 03
    mov ax, word [bp-012h]                    ; 8b 46 ee
    call 01650h                               ; e8 0b d5
    mov bl, al                                ; 88 c3
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    xor bh, bh                                ; 30 ff
    mov dx, 00304h                            ; ba 04 03
    mov ax, word [bp-012h]                    ; 8b 46 ee
    call 0165eh                               ; e8 0a d5
    mov es, [bp-014h]                         ; 8e 46 ec
    cmp byte [es:si+001h], 000h               ; 26 80 7c 01 00
    je short 04162h                           ; 74 04
    mov byte [es:si], 001h                    ; 26 c6 04 01
    mov es, [bp-014h]                         ; 8e 46 ec
    mov al, byte [es:si+002h]                 ; 26 8a 44 02
    xor ah, ah                                ; 30 e4
    ...
    db  010h, 00dh, 00ch, 00bh, 00ah, 009h, 008h, 005h, 004h, 003h, 002h, 001h, 000h, 077h, 045h, 076h
    db  042h, 0a9h, 042h, 0d3h, 042h, 09eh, 042h, 0d3h, 042h, 09eh, 042h, 0c5h, 044h, 0abh, 044h, 077h
    db  045h, 077h, 045h, 0abh, 044h, 0abh, 044h, 0abh, 044h, 0abh, 044h, 0abh, 044h, 06eh, 045h, 0abh
    db  044h, 077h, 045h, 077h, 045h, 077h, 045h, 077h, 045h, 077h, 045h, 077h, 045h, 077h, 045h, 077h
    db  045h, 077h, 045h, 077h, 045h, 077h, 045h, 077h, 045h
_int13_cdemu:                                ; 0xf41d1 LB 0x442
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 4d d4
    mov es, cx                                ; 8e c1
    cmp byte [es:di], 000h                    ; 26 80 3d 00
    je short 04228h                           ; 74 0f
    mov al, byte [es:di+002h]                 ; 26 8a 45 02
    xor ah, ah                                ; 30 e4
    mov dx, word [bp+012h]                    ; 8b 56 12
    xor dh, dh                                ; 30 f6
    cmp ax, dx                                ; 39 d0
    je short 04251h                           ; 74 29
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 f0 d6
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 1b d7
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 04597h                           ; e9 46 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00050h                ; 3d 50 00
    jnbe short 042d0h                         ; 77 74
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0001eh                ; b9 1e 00
    mov di, 04178h                            ; bf 78 41
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+04195h]               ; 2e 8b 85 95 41
    ...
    je short 0429bh                           ; 74 09
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    call word [word bx+00076h]                ; ff 97 76 00
    jmp near 044abh                           ; e9 0d 02
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 003h                               ; 80 cc 03
    jmp near 0459fh                           ; e9 f6 02
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 9e d3
    mov cl, al                                ; 88 c1
    xor ah, ah                                ; 30 e4
    sal ax, 008h                              ; c1 e0 08
    or bx, ax                                 ; 09 c3
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 95 d3
    test cl, cl                               ; 84 c9
    je short 0432dh                           ; 74 60
    jmp near 045b3h                           ; e9 e3 02
    jmp near 04577h                           ; e9 a4 02
    ...
    test cx, cx                               ; 85 c9
    je short 0433bh                           ; 74 1e
    cmp di, word [bp-010h]                    ; 3b 7e f0
    jc short 0432ah                           ; 72 08
    cmp ax, dx                                ; 39 d0
    jnc short 0432ah                          ; 73 04
    cmp si, bx                                ; 39 de
    jc short 04330h                           ; 72 06
    jmp near 04597h                           ; e9 6a 02
    jmp near 044afh                           ; e9 7f 01
    mov dx, word [bp+016h]                    ; 8b 56 16
    shr dx, 008h                              ; c1 ea 08
    cmp dx, strict byte 00004h                ; 83 fa 04
    jne short 0433eh                          ; 75 03
    jmp near 044abh                           ; e9 6d 01
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 0a0c0h                               ; e8 64 5d
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 0a0c0h                               ; e8 57 5d
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
    ...
    mov word [es:bx+020h], strict word 00000h ; 26 c7 47 20 00 00
    test al, al                               ; 84 c0
    je short 044abh                           ; 74 37
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 a4 d4
    mov al, dl                                ; 88 d0
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    mov word [bp+016h], ax                    ; 89 46 16
    mov byte [bp+016h], 000h                  ; c6 46 16 00
    jmp near 045a2h                           ; e9 f7 00
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 a4 d1
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    mov word [bp+010h], ax                    ; 89 46 10
    cmp dl, 003h                              ; 80 fa 03
    je short 04551h                           ; 74 1a
    cmp dl, 002h                              ; 80 fa 02
    je short 0454dh                           ; 74 11
    cmp dl, 001h                              ; 80 fa 01
    jne short 04555h                          ; 75 14
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor al, al                                ; 30 c0
    or AL, strict byte 002h                   ; 0c 02
    mov word [bp+010h], ax                    ; 89 46 10
    jmp short 04555h                          ; eb 08
    or AL, strict byte 004h                   ; 0c 04
    jmp short 04548h                          ; eb f7
    or AL, strict byte 005h                   ; 0c 05
    jmp short 04548h                          ; eb f3
    mov es, [bp-008h]                         ; 8e 46 f8
    cmp byte [es:si+001h], 004h               ; 26 80 7c 01 04
    jc short 04562h                           ; 72 03
    jmp near 044abh                           ; e9 49 ff
    mov word [bp+008h], 0efc7h                ; c7 46 08 c7 ef
    mov word [bp+006h], 0f000h                ; c7 46 06 00 f0
    jmp short 0455fh                          ; eb f1
    or bh, 003h                               ; 80 cf 03
    mov word [bp+016h], bx                    ; 89 5e 16
    jmp near 044afh                           ; e9 38 ff
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 a1 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0034ch                               ; 68 4c 03
    ...
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 044beh                           ; e9 04 ff
    db  050h, 04eh, 049h, 048h, 047h, 046h, 045h, 044h, 043h, 042h, 041h, 018h, 016h, 015h, 014h, 011h
    db  010h, 00dh, 00ch, 00bh, 00ah, 009h, 008h, 005h, 004h, 003h, 002h, 001h, 000h, 001h, 047h, 036h
    db  04bh, 0beh, 046h, 001h, 047h, 0b3h, 046h, 001h, 047h, 0b3h, 046h, 001h, 047h, 036h, 04bh, 001h
    db  047h, 001h, 047h, 036h, 04bh, 036h, 04bh, 036h, 04bh, 036h, 04bh, 036h, 04bh, 0e5h, 046h, 036h
    db  04bh, 001h, 047h, 0eeh, 046h, 01dh, 047h, 0b3h, 046h, 01dh, 047h, 05fh, 048h, 0fah, 048h, 01dh
    db  047h, 022h, 049h, 050h, 04bh, 058h, 04bh, 001h, 047h
_int13_cdrom:                                ; 0xf4613 LB 0x57d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 26 d0
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    cmp ax, 000e0h                            ; 3d e0 00
    jc short 04647h                           ; 72 05
    cmp ax, 000f0h                            ; 3d f0 00
    jc short 04665h                           ; 72 1e
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 07 d3
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 04b6eh                           ; e9 09 05
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    ...
    jmp short 0465ah                          ; eb cc
    mov ax, word [bp+018h]                    ; 8b 46 18
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00050h                ; 3d 50 00
    jnbe short 04701h                         ; 77 68
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0001eh                ; b9 1e 00
    mov di, 045bah                            ; bf ba 45
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+045d7h]               ; 2e 8b 85 d7 45
    ...
    xor ah, ah                                ; 30 e4
    or ah, 003h                               ; 80 cc 03
    jmp near 04b76h                           ; e9 b8 04
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 89 cf
    mov cl, al                                ; 88 c1
    xor ah, ah                                ; 30 e4
    sal ax, 008h                              ; c1 e0 08
    or bx, ax                                 ; 09 c3
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 80 cf
    test cl, cl                               ; 84 c9
    je short 046feh                           ; 74 1c
    jmp near 04b8ah                           ; e9 a5 04
    or bh, 002h                               ; 80 cf 02
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 04b79h                           ; e9 8b 04
    mov word [bp+012h], 0aa55h                ; c7 46 12 55 aa
    or bh, 030h                               ; 80 cf 30
    mov word [bp+018h], bx                    ; 89 5e 18
    mov word [bp+016h], strict word 00007h    ; c7 46 16 07 00
    jmp near 04b3ah                           ; e9 39 04
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 17 d2
    mov ax, word [bp+018h]                    ; 8b 46 18
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 003dfh                               ; 68 df 03
    ...
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 06 d2
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 04b6eh                           ; e9 08 04
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    je short 0478dh                           ; 74 05
    cmp ax, strict word 00047h                ; 3d 47 00
    jne short 04790h                          ; 75 03
    jmp near 04b36h                           ; e9 a6 03
    mov cx, strict word 0000ch                ; b9 0c 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-030h]                         ; 8d 46 d0
    call 0a130h                               ; e8 93 59
    ...
    je short 04885h                           ; 74 53
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 e6 d0
    mov al, byte [bp-018h]                    ; 8a 46 e8
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 15 d1
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 04b76h                           ; e9 17 03
    cmp bx, strict byte 00002h                ; 83 fb 02
    jnbe short 048cdh                         ; 77 69
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-01eh]                         ; 8e 46 e2
    ...
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 048e3h                           ; 74 67
    cmp bx, strict byte 00001h                ; 83 fb 01
    je short 048bdh                           ; 74 3c
    test bx, bx                               ; 85 db
    je short 04888h                           ; 74 03
    jmp near 04b36h                           ; e9 ae 02
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 0489eh                          ; 75 12
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 0b4h                               ; 80 cc b4
    ...
    or AL, strict byte 001h                   ; 0c 01
    mov word [bp+018h], ax                    ; 89 46 18
    jmp short 04885h                          ; eb c8
    test al, al                               ; 84 c0
    jne short 048d0h                          ; 75 0f
    or bh, 0b0h                               ; 80 cf b0
    mov word [bp+018h], bx                    ; 89 5e 18
    mov byte [bp+018h], al                    ; 88 46 18
    jmp near 04b79h                           ; e9 ac 02
    jmp near 04b6eh                           ; e9 9e 02
    mov dl, byte [bp-006h]                    ; 8a 56 fa
    xor dh, dh                                ; 30 f6
    imul dx, dx, strict byte 0001ch           ; 6b d2 1c
    db  0feh, 0c8h
    ...
    mov byte [es:si+025h], al                 ; 26 88 44 25
    test al, al                               ; 84 c0
    jne short 048f5h                          ; 75 0e
    xor ah, ah                                ; 30 e4
    mov dx, word [bp+018h]                    ; 8b 56 18
    xor dl, dl                                ; 30 d2
    or dx, ax                                 ; 09 c2
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 04885h                          ; eb 90
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 048e9h                          ; eb ef
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-01eh]                         ; 8e 46 e2
    ...
    test al, al                               ; 84 c0
    je short 04915h                           ; 74 06
    or bh, 0b1h                               ; 80 cf b1
    jmp near 046e8h                           ; e9 d3 fd
    je short 0493eh                           ; 74 27
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 0b1h                               ; 80 cc b1
    jmp near 04b76h                           ; e9 54 02
    ...
    jnc short 04941h                          ; 73 05
    jmp short 048cdh                          ; eb 8f
    jmp near 04b36h                           ; e9 f5 01
    jc short 049a5h                           ; 72 62
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-01eh]                         ; 8e 46 e2
    ...
    xor cl, cl                                ; 30 c9
    xor ch, ch                                ; 30 ed
    jmp short 04a4ah                          ; eb 05
    cmp ch, 00fh                              ; 80 fd 0f
    jnc short 04a60h                          ; 73 16
    mov al, ch                                ; 88 e8
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    add dx, 00356h                            ; 81 c2 56 03
    mov ax, word [bp-016h]                    ; 8b 46 ea
    call 01650h                               ; e8 f6 cb
    add cl, al                                ; 00 c1
    db  0feh, 0c5h
    ; inc ch                                    ; fe c5
    jmp short 04a45h                          ; eb e5
    neg cl                                    ; f6 d9
    mov es, [bp-01eh]                         ; 8e 46 e2
    mov byte [es:si+00243h], cl               ; 26 88 8c 43 02
    cmp word [bp-00ch], strict byte 00042h    ; 83 7e f4 42
    jnc short 04a73h                          ; 73 03
    jmp near 04b36h                           ; e9 c3 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    cwd                                       ; 99
    db  02bh, 0c2h
    ...
    jmp short 04b1bh                          ; eb 05
    cmp ah, 040h                              ; 80 fc 40
    jnc short 04b2dh                          ; 73 12
    mov dl, ah                                ; 88 e2
    xor dh, dh                                ; 30 f6
    mov es, [bp-00ah]                         ; 8e 46 f6
    mov si, bx                                ; 89 de
    ...
    or bh, 006h                               ; 80 cf 06
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 04b8ah                          ; eb 32
    cmp bx, strict byte 00006h                ; 83 fb 06
    je short 04b36h                           ; 74 d9
    cmp bx, strict byte 00001h                ; 83 fb 01
    jc short 04b6eh                           ; 72 0c
    jbe short 04b36h                          ; 76 d2
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 04b6eh                           ; 72 05
    cmp bx, strict byte 00004h                ; 83 fb 04
    jbe short 04b36h                          ; 76 c8
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+018h], ax                    ; 89 46 18
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 d4 ca
    or byte [bp+01eh], 001h                   ; 80 4e 1e 01
    jmp short 04b49h                          ; eb b9
print_boot_device_:                          ; 0xf4b90 LB 0x4b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    test al, al                               ; 84 c0
    je short 04b9dh                           ; 74 05
    mov dx, strict word 00002h                ; ba 02 00
    jmp short 04bb7h                          ; eb 1a
    test dl, dl                               ; 84 d2
    je short 04ba6h                           ; 74 05
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 04bb7h                          ; eb 11
    test bl, 080h                             ; f6 c3 80
    jne short 04bafh                          ; 75 04
    xor dh, dh                                ; 30 f6
    jmp short 04bb7h                          ; eb 08
    test bl, 080h                             ; f6 c3 80
    je short 04bd5h                           ; 74 21
    mov dx, strict word 00001h                ; ba 01 00
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 61 cd
    imul dx, dx, strict byte 0000ah           ; 6b d2 0a
    add dx, 00dc6h                            ; 81 c2 c6 0d
    push dx                                   ; 52
    push 00494h                               ; 68 94 04
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 94 cd
    add sp, strict byte 00006h                ; 83 c4 06
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
print_boot_failure_:                         ; 0xf4bdb LB 0x96
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov ah, dl                                ; 88 d4
    ...
    mov si, cx                                ; 89 ce
    test al, al                               ; 84 c0
    je short 04c0bh                           ; 74 1b
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 28 cd
    push 00ddah                               ; 68 da 0d
    push 004a8h                               ; 68 a8 04
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 60 cd
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 04c4fh                          ; eb 44
    test ah, ah                               ; 84 e4
    je short 04c1fh                           ; 74 10
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 09 cd
    push 00de4h                               ; 68 e4 0d
    jmp short 04bfeh                          ; eb df
    test bl, 080h                             ; f6 c3 80
    je short 04c35h                           ; 74 11
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 f4 cc
    push si                                   ; 56
    push 00dd0h                               ; 68 d0 0d
    jmp short 04c44h                          ; eb 0f
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 e3 cc
    push si                                   ; 56
    push 00dc6h                               ; 68 c6 0d
    push 004bdh                               ; 68 bd 04
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 1a cd
    add sp, strict byte 00008h                ; 83 c4 08
    cmp byte [bp+004h], 001h                  ; 80 7e 04 01
    jne short 04c69h                          ; 75 14
    test dl, dl                               ; 84 d2
    jne short 04c5eh                          ; 75 05
    push 004d5h                               ; 68 d5 04
    jmp short 04c61h                          ; eb 03
    push 004ffh                               ; 68 ff 04
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 00 cd
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 00002h                               ; c2 02 00
print_cdromboot_failure_:                    ; 0xf4c71 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 9f cc
    push dx                                   ; 52
    push 00534h                               ; 68 34 05
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 d9 cc
    add sp, strict byte 00006h                ; 83 c4 06
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int19_function:                             ; 0xf4c98 LB 0x271
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, bx                                ; 89 d8
    call 01650h                               ; e8 6c c9
    test al, al                               ; 84 c0
    je short 04cf4h                           ; 74 0c
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, bx                                ; 89 d8
    call 01650h                               ; e8 60 c9
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    cmp byte [bp+004h], 001h                  ; 80 7e 04 01
    jne short 04d0ah                          ; 75 10
    mov ax, strict word 0003ch                ; b8 3c 00
    call 016ach                               ; e8 ac c9
    and AL, strict byte 0f0h                  ; 24 f0
    xor ah, ah                                ; 30 e4
    sar ax, 004h                              ; c1 f8 04
    call 07de8h                               ; e8 de 30
    cmp byte [bp+004h], 002h                  ; 80 7e 04 02
    jne short 04d13h                          ; 75 03
    shr si, 004h                              ; c1 ee 04
    cmp byte [bp+004h], 003h                  ; 80 7e 04 03
    jne short 04d1ch                          ; 75 03
    shr si, 008h                              ; c1 ee 08
    cmp byte [bp+004h], 004h                  ; 80 7e 04 04
    jne short 04d25h                          ; 75 03
    shr si, 00ch                              ; c1 ee 0c
    cmp si, strict byte 00010h                ; 83 fe 10
    jnc short 04d2eh                          ; 73 04
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    call 04b90h                               ; e8 5f fd
    mov word [bp-012h], strict word 00006h    ; c7 46 ee 06 00
    mov word [bp-010h], cx                    ; 89 4e f0
    jmp short 04e5ch                          ; eb 21
    jmp short 04e62h                          ; eb 25
    mov bl, byte [bp-006h]                    ; 8a 5e fa
    xor bh, bh                                ; 30 ff
    mov dl, byte [bp-00ah]                    ; 8a 56 f6
    xor dh, dh                                ; 30 f6
    ...
    jmp near 04dafh                           ; e9 4d ff
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jne short 04e8fh                          ; 75 27
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    jne short 04e8fh                          ; 75 21
    ...
    test ax, ax                               ; 85 c0
    je short 04e8fh                           ; 74 03
    jmp near 04dafh                           ; e9 20 ff
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 04e99h                           ; 74 04
    xor bl, bl                                ; 30 db
    jmp short 04e9bh                          ; eb 02
    mov BL, strict byte 001h                  ; b3 01
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    je short 04ea3h                           ; 74 02
    mov BL, strict byte 001h                  ; b3 01
    xor dx, dx                                ; 31 d2
    mov ax, di                                ; 89 f8
    ...
    cmp si, ax                                ; 39 c6
    je short 04ec9h                           ; 74 11
    test bl, bl                               ; 84 db
    jne short 04ee1h                          ; 75 25
    mov dx, 001feh                            ; ba fe 01
    mov ax, di                                ; 89 f8
    call 0166ch                               ; e8 a8 c7
    cmp ax, 0aa55h                            ; 3d 55 aa
    je short 04ee1h                           ; 74 18
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov bl, byte [bp-006h]                    ; 8a 5e fa
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
keyboard_panic_:                             ; 0xf4f09 LB 0x13
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push ax                                   ; 50
    push 00574h                               ; 68 74 05
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 51 ca
    add sp, strict byte 00006h                ; 83 c4 06
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_keyboard_init:                              ; 0xf4f1c LB 0x26a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov AL, strict byte 0aah                  ; b0 aa
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 04f3fh                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04f3fh                          ; 76 08
    xor al, al                                ; 30 c0
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04f28h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04f48h                          ; 75 05
    xor ax, ax                                ; 31 c0
    call 04f09h                               ; e8 c1 ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04f62h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04f62h                          ; 76 08
    mov AL, strict byte 001h                  ; b0 01
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04f4bh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04f6ch                          ; 75 06
    mov ax, strict word 00001h                ; b8 01 00
    call 04f09h                               ; e8 9d ff
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, strict word 00055h                ; 3d 55 00
    je short 04f7dh                           ; 74 06
    mov ax, 003dfh                            ; b8 df 03
    call 04f09h                               ; e8 8c ff
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 04f9dh                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04f9dh                          ; 76 08
    mov AL, strict byte 010h                  ; b0 10
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04f86h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04fa7h                          ; 75 06
    mov ax, strict word 0000ah                ; b8 0a 00
    call 04f09h                               ; e8 62 ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04fc1h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04fc1h                          ; 76 08
    mov AL, strict byte 011h                  ; b0 11
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04faah                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04fcbh                          ; 75 06
    mov ax, strict word 0000bh                ; b8 0b 00
    call 04f09h                               ; e8 3e ff
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04ffbh                          ; 76 08
    mov AL, strict byte 020h                  ; b0 20
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04fe4h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 05005h                          ; 75 06
    mov ax, strict word 00014h                ; b8 14 00
    call 04f09h                               ; e8 04 ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    call 04f09h                               ; e8 e0 fe
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 0503ah                           ; 74 06
    mov ax, 003e1h                            ; b8 e1 03
    call 04f09h                               ; e8 cf fe
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0504ch                          ; 75 08
    mov AL, strict byte 031h                  ; b0 31
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 0503ah                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000aah                            ; 3d aa 00
    je short 05065h                           ; 74 0e
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000aah                            ; 3d aa 00
    je short 05065h                           ; 74 06
    mov ax, 003e2h                            ; b8 e2 03
    call 04f09h                               ; e8 a4 fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 05085h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05085h                          ; 76 08
    mov AL, strict byte 040h                  ; b0 40
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 0506eh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 0508fh                          ; 75 06
    mov ax, strict word 00028h                ; b8 28 00
    call 04f09h                               ; e8 7a fe
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 050a9h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 050a9h                          ; 76 08
    mov AL, strict byte 041h                  ; b0 41
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05092h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 050b3h                          ; 75 06
    mov ax, strict word 00029h                ; b8 29 00
    call 04f09h                               ; e8 56 fe
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 050c4h                           ; 74 06
    mov ax, 003e3h                            ; b8 e3 03
    call 04f09h                               ; e8 45 fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 050e4h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 050e4h                          ; 76 08
    mov AL, strict byte 050h                  ; b0 50
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 050cdh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 050eeh                          ; 75 06
    mov ax, strict word 00032h                ; b8 32 00
    call 04f09h                               ; e8 1b fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 0510eh                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 0510eh                          ; 76 08
    mov AL, strict byte 060h                  ; b0 60
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 050f7h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 05118h                          ; 75 06
    mov ax, strict word 0003ch                ; b8 3c 00
    call 04f09h                               ; e8 f1 fd
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 05138h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05138h                          ; 76 08
    mov AL, strict byte 070h                  ; b0 70
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05121h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 05142h                          ; 75 06
    mov ax, strict word 00046h                ; b8 46 00
    call 04f09h                               ; e8 c7 fd
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0515ch                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 0515ch                          ; 76 08
    mov AL, strict byte 071h                  ; b0 71
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05145h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 05166h                          ; 75 06
    mov ax, strict word 00046h                ; b8 46 00
    call 04f09h                               ; e8 a3 fd
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 05177h                           ; 74 06
    mov ax, 003e4h                            ; b8 e4 03
    call 04f09h                               ; e8 92 fd
    mov AL, strict byte 0a8h                  ; b0 a8
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    xor ax, ax                                ; 31 c0
    call 06629h                               ; e8 a7 14
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
enqueue_key_:                                ; 0xf5186 LB 0x9e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 d0 c4
    mov di, ax                                ; 89 c7
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 c5 c4
    mov si, ax                                ; 89 c6
    lea cx, [si+002h]                         ; 8d 4c 02
    cmp cx, strict byte 0003eh                ; 83 f9 3e
    jc short 051b4h                           ; 72 03
    mov cx, strict word 0001eh                ; b9 1e 00
    cmp cx, di                                ; 39 f9
    jne short 051bch                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 051e6h                          ; eb 2a
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, si                                ; 89 f2
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 94 c4
    mov bl, byte [bp-00ah]                    ; 8a 5e f6
    xor bh, bh                                ; 30 ff
    lea dx, [si+001h]                         ; 8d 54 01
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 86 c4
    mov bx, cx                                ; 89 cb
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 97 c4
    mov ax, strict word 00001h                ; b8 01 00
    ...
    db  01dh, 062h, 055h, 01ah, 053h, 0bch, 052h, 0bch, 052h, 0a9h, 053h, 093h, 052h, 02dh, 054h, 0a1h
    db  054h, 048h, 055h, 026h, 055h, 061h, 053h, 0bch, 052h, 0bch, 052h, 0ebh, 053h, 0b1h, 052h, 081h
    db  054h, 006h, 055h, 041h, 055h
_int09_function:                             ; 0xf5224 LB 0x494
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    sub sp, strict byte 0000eh                ; 83 ec 0e
    ...
    mov byte [bp-00ah], al                    ; 88 46 f6
    test al, al                               ; 84 c0
    jne short 0524eh                          ; 75 19
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 e3 c6
    push 00587h                               ; 68 87 05
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 1e c7
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 05314h                           ; e9 c6 00
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 f9 c3
    mov byte [bp-010h], al                    ; 88 46 f0
    mov byte [bp-008h], al                    ; 88 46 f8
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 ea c3
    mov byte [bp-004h], al                    ; 88 46 fc
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 db c3
    mov byte [bp-006h], al                    ; 88 46 fa
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    push CS                                   ; 0e
    ...
    mov di, 051efh                            ; bf ef 51
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+05200h]               ; 2e 8b 85 00 52
    jmp ax                                    ; ff e0
    ...
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 4a c3
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop di                                    ; 5f
    pop bp                                    ; 5d
    retn                                      ; c3
    test byte [bp-004h], 001h                 ; f6 46 fc 01
    jne short 052f5h                          ; 75 d5
    mov al, byte [bp-006h]                    ; 8a 46 fa
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor ah, ah                                ; 30 e4
    ...
    mov al, byte [bp-004h]                    ; 8a 46 fc
    test AL, strict byte 002h                 ; a8 02
    je short 0534ah                           ; 74 0e
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-00ch], al                    ; 88 46 f4
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 05359h                          ; eb 0f
    mov al, byte [bp-010h]                    ; 8a 46 f0
    or AL, strict byte 001h                   ; 0c 01
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 ff c2
    jmp short 052f5h                          ; eb 94
    test byte [bp-004h], 001h                 ; f6 46 fc 01
    jne short 052f5h                          ; 75 8e
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 0fbh                  ; 24 fb
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 e2 c2
    mov al, byte [bp-004h]                    ; 8a 46 fc
    test AL, strict byte 002h                 ; a8 02
    je short 05391h                           ; 74 0e
    and AL, strict byte 0fbh                  ; 24 fb
    mov byte [bp-00ch], al                    ; 88 46 f4
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 053a0h                          ; eb 0f
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 b8 c2
    jmp near 052f5h                           ; e9 4c ff
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 a0 c2
    mov al, byte [bp-004h]                    ; 8a 46 fc
    test AL, strict byte 002h                 ; a8 02
    je short 053d3h                           ; 74 0e
    or AL, strict byte 008h                   ; 0c 08
    mov byte [bp-00ch], al                    ; 88 46 f4
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 053e2h                          ; eb 0f
    mov al, byte [bp-010h]                    ; 8a 46 f0
    or AL, strict byte 002h                   ; 0c 02
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 76 c2
    jmp near 052f5h                           ; e9 0a ff
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 5e c2
    mov al, byte [bp-004h]                    ; 8a 46 fc
    test AL, strict byte 002h                 ; a8 02
    je short 05415h                           ; 74 0e
    and AL, strict byte 0f7h                  ; 24 f7
    mov byte [bp-00ch], al                    ; 88 46 f4
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 05424h                          ; eb 0f
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    jmp near 052f5h                           ; e9 c8 fe
    test byte [bp-004h], 003h                 ; f6 46 fc 03
    jne short 05453h                          ; 75 20
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 16 c2
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor AL, strict byte 020h                  ; 34 20
    mov byte [bp-00eh], al                    ; 88 46 f2
    jmp near 052e8h                           ; e9 95 fe
    mov al, byte [bp-010h]                    ; 8a 46 f0
    or AL, strict byte 008h                   ; 0c 08
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 f6 c1
    mov AL, strict byte 0aeh                  ; b0 ae
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    call 0e034h                               ; e8 c3 8b
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 d6 c1
    test AL, strict byte 008h                 ; a8 08
    jne short 05471h                          ; 75 f3
    jmp near 052f5h                           ; e9 74 fe
    test byte [bp-004h], 003h                 ; f6 46 fc 03
    je short 0548ah                           ; 74 03
    jmp near 052f5h                           ; e9 6b fe
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 bf c1
    jmp short 05487h                          ; eb e6
    test byte [bp-004h], 002h                 ; f6 46 fc 02
    je short 054dah                           ; 74 33
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 bc c1
    mov bx, ax                                ; 89 c3
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 bf c1
    mov bx, 00080h                            ; bb 80 00
    mov dx, strict word 00071h                ; ba 71 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 97 c1
    mov AL, strict byte 0aeh                  ; b0 ae
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    push bp                                   ; 55
    ...
    xor dx, dx                                ; 31 d2
    xor ax, ax                                ; 31 c0
    call 05186h                               ; e8 ae fc
    jmp short 05487h                          ; eb ad
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 5a c1
    jmp short 05487h                          ; eb 81
    test byte [bp-004h], 002h                 ; f6 46 fc 02
    je short 0550fh                           ; 74 03
    jmp near 052f5h                           ; e9 e6 fd
    mov al, byte [bp-010h]                    ; 8a 46 f0
    and AL, strict byte 0efh                  ; 24 ef
    mov byte [bp-008h], al                    ; 88 46 f8
    mov bl, al                                ; 88 c3
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 3a c1
    jmp short 0550ch                          ; eb e6
    mov al, byte [bp-010h]                    ; 8a 46 f0
    test AL, strict byte 004h                 ; a8 04
    jne short 0550ch                          ; 75 df
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 1f c1
    jmp short 0550ch                          ; eb cb
    mov al, byte [bp-010h]                    ; 8a 46 f0
    and AL, strict byte 0fbh                  ; 24 fb
    jmp short 05514h                          ; eb cc
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 00ch                  ; 24 0c
    cmp AL, strict byte 00ch                  ; 3c 0c
    jne short 05562h                          ; 75 11
    mov bx, 01234h                            ; bb 34 12
    mov dx, strict word 00072h                ; ba 72 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 1d c1
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    test byte [bp-008h], 008h                 ; f6 46 f8 08
    je short 05577h                           ; 74 0f
    and byte [bp-008h], 0f7h                  ; 80 66 f8 f7
    mov bl, byte [bp-008h]                    ; 8a 5e f8
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00018h                ; ba 18 00
    jmp near 0530eh                           ; e9 97 fd
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    test AL, strict byte 080h                 ; a8 80
    je short 055b5h                           ; 74 37
    cmp AL, strict byte 0fah                  ; 3c fa
    jne short 05594h                          ; 75 12
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 c5 c0
    mov bl, al                                ; 88 c3
    or bl, 010h                               ; 80 cb 10
    xor bh, bh                                ; 30 ff
    jmp short 055aah                          ; eb 16
    cmp AL, strict byte 0feh                  ; 3c fe
    je short 0559bh                           ; 74 03
    jmp near 052f5h                           ; e9 5a fd
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 ac c0
    or AL, strict byte 020h                   ; 0c 20
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 ab c0
    jmp short 05598h                          ; eb e3
    cmp byte [bp-00ah], 058h                  ; 80 7e f6 58
    jbe short 055dah                          ; 76 1f
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 5d c3
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 005a1h                               ; 68 a1 05
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 92 c3
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 05314h                           ; e9 3a fd
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    test AL, strict byte 008h                 ; a8 08
    je short 055f4h                           ; 74 13
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    imul bx, ax, strict byte 0000ah           ; 6b d8 0a
    mov dl, byte [bx+00df4h]                  ; 8a 97 f4 0d
    mov ax, word [bx+00df4h]                  ; 8b 87 f4 0d
    jmp near 05684h                           ; e9 90 00
    test AL, strict byte 004h                 ; a8 04
    je short 0560bh                           ; 74 13
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    imul bx, ax, strict byte 0000ah           ; 6b d8 0a
    mov dl, byte [bx+00df2h]                  ; 8a 97 f2 0d
    mov ax, word [bx+00df2h]                  ; 8b 87 f2 0d
    jmp near 05684h                           ; e9 79 00
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    and AL, strict byte 002h                  ; 24 02
    test al, al                               ; 84 c0
    jbe short 05628h                          ; 76 14
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 047h                  ; 3c 47
    jc short 05628h                           ; 72 0d
    cmp AL, strict byte 053h                  ; 3c 53
    jnbe short 05628h                         ; 77 09
    mov DL, strict byte 0e0h                  ; b2 e0
    xor ah, ah                                ; 30 e4
    imul bx, ax, strict byte 0000ah           ; 6b d8 0a
    jmp short 05680h                          ; eb 58
    test byte [bp-00eh], 003h                 ; f6 46 f2 03
    je short 0565dh                           ; 74 2f
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    imul bx, ax, strict byte 0000ah           ; 6b d8 0a
    ...
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    test ax, dx                               ; 85 d0
    je short 0567ch                           ; 74 0a
    mov dl, byte [bx+00df0h]                  ; 8a 97 f0 0d
    mov ax, word [bx+00df0h]                  ; 8b 87 f0 0d
    jmp short 05684h                          ; eb 08
    mov dl, byte [bx+00deeh]                  ; 8a 97 ee 0d
    mov ax, word [bx+00deeh]                  ; 8b 87 ee 0d
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    jne short 056aah                          ; 75 1a
    test dl, dl                               ; 84 d2
    jne short 056aah                          ; 75 16
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 84 c2
    push 005d8h                               ; 68 d8 05
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 bf c2
    add sp, strict byte 00004h                ; 83 c4 04
    mov bl, dl                                ; 88 d3
    xor bh, bh                                ; 30 ff
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    mov dx, bx                                ; 89 da
    jmp near 054d5h                           ; e9 1d fe
dequeue_key_:                                ; 0xf56b8 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 9a bf
    mov bx, ax                                ; 89 c3
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 8f bf
    cmp bx, ax                                ; 39 c3
    je short 0571eh                           ; 74 3d
    mov dx, bx                                ; 89 da
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 67 bf
    mov cl, al                                ; 88 c1
    ...
    cmp word [bp+004h], strict byte 00000h    ; 83 7e 04 00
    je short 05719h                           ; 74 13
    inc bx                                    ; 43
    inc bx                                    ; 43
    cmp bx, strict byte 0003eh                ; 83 fb 3e
    jc short 05710h                           ; 72 03
    mov bx, strict word 0001eh                ; bb 1e 00
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 61 bf
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 05720h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    add byte [bx+di+058h], dl                 ; 00 51 58
    or byte [bx+si-066h], bl                  ; 08 58 9a
    pop ax                                    ; 58
    out 058h, ax                              ; e7 58
    clc                                       ; f8
    pop ax                                    ; 58
    and word [bx+di+02ah], bx                 ; 21 59 2a
    pop cx                                    ; 59
    wait                                      ; 9b
    pop cx                                    ; 59
    int 059h                                  ; cd 59
    ...
    xchg sp, ax                               ; 94
    pop ax                                    ; 58
_int16_function:                             ; 0xf574c LB 0x2f5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 f4 be
    mov cl, al                                ; 88 c1
    mov bl, al                                ; 88 c3
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 e7 be
    mov bh, al                                ; 88 c7
    mov dl, cl                                ; 88 ca
    xor dh, dh                                ; 30 f6
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05798h                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05786h                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 057e7h                          ; 75 44
    mov dl, bh                                ; 88 fa
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 057d4h                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 057c2h                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 77 be
    sti                                       ; fb
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, 008h                              ; c1 e8 08
    cmp ax, 000a2h                            ; 3d a2 00
    jnbe short 05851h                         ; 77 5e
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0000ch                ; b9 0c 00
    mov di, 05729h                            ; bf 29 57
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+05734h]               ; 2e 8b 85 34 57
    jmp ax                                    ; ff e0
    push strict byte 00001h                   ; 6a 01
    mov cx, ss                                ; 8c d1
    ...
    call 056b8h                               ; e8 a1 fe
    test ax, ax                               ; 85 c0
    jne short 05826h                          ; 75 0b
    push 0060fh                               ; 68 0f 06
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 43 c1
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 05832h                           ; 74 06
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je short 05838h                           ; 74 06
    cmp byte [bp-008h], 0e0h                  ; 80 7e f8 e0
    jne short 0583ch                          ; 75 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    ...
    or dx, ax                                 ; 09 c2
    mov word [bp+012h], dx                    ; 89 56 12
    jmp near 05894h                           ; e9 43 00
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 c7 c0
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00633h                               ; 68 33 06
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 fb c0
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 aa c0
    ...
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 056b8h                               ; e8 09 fe
    test ax, ax                               ; 85 c0
    jne short 058b9h                          ; 75 06
    or word [bp+01eh], strict byte 00040h     ; 83 4e 1e 40
    jmp short 05894h                          ; eb db
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    ...
    jmp short 05894h                          ; eb ad
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 60 bd
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    jmp near 0584bh                           ; e9 53 ff
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, word [bp+010h]                    ; 8b 46 10
    shr ax, 008h                              ; c1 e8 08
    xor ah, ah                                ; 30 e4
    call 05186h                               ; e8 7e f8
    test ax, ax                               ; 85 c0
    jne short 05919h                          ; 75 0d
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 001h                   ; 0c 01
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 05894h                           ; e9 7b ff
    and word [bp+012h], 0ff00h                ; 81 66 12 00 ff
    jmp near 05894h                           ; e9 73 ff
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 030h                   ; 0c 30
    jmp short 05913h                          ; eb e9
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05951h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05951h                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 0593ah                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 05995h                          ; 76 40
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 05995h                          ; 75 35
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0597ah                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 0597ah                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 05963h                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 0598ch                          ; 76 0e
    shr cx, 008h                              ; c1 e9 08
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    jnbe short 05960h                         ; 77 cb
    mov word [bp+00ch], cx                    ; 89 4e 0c
    jmp near 05894h                           ; e9 f9 fe
    push strict byte 00001h                   ; 6a 01
    mov cx, ss                                ; 8c d1
    lea bx, [bp-008h]                         ; 8d 5e f8
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 056b8h                               ; e8 0e fd
    test ax, ax                               ; 85 c0
    jne short 059b9h                          ; 75 0b
    push 0060fh                               ; 68 0f 06
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 b0 bf
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    jne short 059c2h                          ; 75 03
    jmp near 0583ch                           ; e9 7a fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    jne short 059cbh                          ; 75 03
    jmp near 05838h                           ; e9 6d fe
    jmp short 059bfh                          ; eb f2
    mov ax, word [bp+018h]                    ; 8b 46 18
    mov word [bp+01eh], ax                    ; 89 46 1e
    push strict byte 00000h                   ; 6a 00
    mov cx, ss                                ; 8c d1
    ...
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 056b8h                               ; e8 d6 fc
    test ax, ax                               ; 85 c0
    jne short 059e9h                          ; 75 03
    jmp near 058b3h                           ; e9 ca fe
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    jne short 059f2h                          ; 75 03
    jmp near 058cfh                           ; e9 dd fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    jne short 059fbh                          ; 75 03
    jmp near 058cbh                           ; e9 d0 fe
    jmp short 059efh                          ; eb f2
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 4a bc
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    mov word [bp+012h], dx                    ; 89 56 12
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 39 bc
    mov bl, al                                ; 88 c3
    and bl, 073h                              ; 80 e3 73
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 2b bc
    and AL, strict byte 00ch                  ; 24 0c
    or al, bl                                 ; 08 d8
    mov dx, word [bp+012h]                    ; 8b 56 12
    xor dh, dh                                ; 30 f6
    xor ah, ah                                ; 30 e4
    sal ax, 008h                              ; c1 e0 08
    jmp near 05849h                           ; e9 13 fe
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    jmp near 05913h                           ; e9 d2 fe
set_geom_lba_:                               ; 0xf5a41 LB 0xe7
    push bx                                   ; 53
    push cx                                   ; 51
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    mov si, strict word 00020h                ; be 20 00
    call 0a110h                               ; e8 a2 46
    test ax, ax                               ; 85 c0
    jne short 05a7eh                          ; 75 0c
    test bx, bx                               ; 85 db
    jne short 05a7eh                          ; 75 08
    test cx, cx                               ; 85 c9
    jne short 05a7eh                          ; 75 04
    test dx, dx                               ; 85 d2
    je short 05a85h                           ; 74 07
    mov bx, strict word 0ffffh                ; bb ff ff
    mov si, bx                                ; 89 de
    jmp short 05a8bh                          ; eb 06
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov si, word [bp+00eh]                    ; 8b 76 0e
    mov word [bp-004h], bx                    ; 89 5e fc
    xor bx, bx                                ; 31 db
    jmp short 05a97h                          ; eb 05
    cmp bx, strict byte 00004h                ; 83 fb 04
    jnl short 05abah                          ; 7d 23
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp si, ax                                ; 39 c6
    jc short 05aa8h                           ; 72 0a
    jne short 05ab1h                          ; 75 11
    mov ax, word [bp-004h]                    ; 8b 46 fc
    cmp ax, word [bp-008h]                    ; 3b 46 f8
    jnbe short 05ab1h                         ; 77 09
    ...
    mov AH, strict byte 05bh                  ; b4 5b
    lds bx, [bp+di-00ch]                      ; c5 5b f4
    pop bx                                    ; 5b
    hlt                                       ; f4
    pop bx                                    ; 5b
    hlt                                       ; f4
    ...
    sbb ax, 01d5fh                            ; 1d 5f 1d
    pop di                                    ; 5f
    adc word [bp-006h], bx                    ; 11 5e fa
    pop si                                    ; 5e
    sbb ax, 01d5fh                            ; 1d 5f 1d
    pop di                                    ; 5f
    cli                                       ; fa
    ...
    db  01dh
    pop di                                    ; 5f
_int13_harddisk:                             ; 0xf5b28 LB 0x453
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00010h                ; 83 ec 10
    or byte [bp+01dh], 002h                   ; 80 4e 1d 02
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 31 bb
    mov si, 00122h                            ; be 22 01
    mov word [bp-010h], ax                    ; 89 46 f0
    xor bx, bx                                ; 31 db
    mov dx, 0008eh                            ; ba 8e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 12 bb
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 05b5bh                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 05b79h                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 f3 bd
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 05f38h                           ; e9 bf 03
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    mov es, [bp-010h]                         ; 8e 46 f0
    mov bx, si                                ; 89 f3
    ...
    jmp short 05b6eh                          ; eb cc
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    cmp bx, strict byte 00018h                ; 83 fb 18
    jnbe short 05bf1h                         ; 77 44
    add bx, bx                                ; 01 db
    jmp word [cs:bx+05af6h]                   ; 2e ff a7 f6 5a
    cmp byte [bp-002h], 008h                  ; 80 7e fe 08
    jnc short 05bc2h                          ; 73 08
    mov al, byte [bp-002h]                    ; 8a 46 fe
    xor ah, ah                                ; 30 e4
    call 01d85h                               ; e8 c3 c1
    jmp near 05dfah                           ; e9 35 02
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 82 ba
    mov cl, al                                ; 88 c1
    mov dx, word [bp+016h]                    ; 8b 56 16
    xor dh, dh                                ; 30 f6
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 74 ba
    test cl, cl                               ; 84 c9
    je short 05c52h                           ; 74 64
    jmp near 05f54h                           ; e9 63 03
    jmp near 05f1dh                           ; e9 29 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    mov word [bp-00ch], ax                    ; 89 46 f4
    ...
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    cmp ax, 00080h                            ; 3d 80 00
    jnbe short 05c2fh                         ; 77 04
    test ax, ax                               ; 85 c0
    jne short 05c55h                          ; 75 26
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 e9 bc
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 1a bd
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05f38h                           ; e9 e6 02
    jmp near 05dfeh                           ; e9 a9 01
    mov al, byte [bp-002h]                    ; 8a 46 fe
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    mov word [bp-008h], dx                    ; 89 56 f8
    cmp di, ax                                ; 39 c7
    jnc short 05c83h                          ; 73 0c
    cmp cx, word [bp-006h]                    ; 3b 4e fa
    jbe short 05c83h                          ; 76 07
    mov ax, word [bp-004h]                    ; 8b 46 fc
    cmp ax, dx                                ; 39 d0
    jbe short 05cb3h                          ; 76 30
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 95 bc
    ...
    jne short 05ce7h                          ; 75 14
    mov ax, word [es:bx+034h]                 ; 26 8b 47 34
    cmp ax, word [bp-008h]                    ; 3b 46 f8
    je short 05ce1h                           ; 74 05
    jmp short 05ce7h                          ; eb 09
    jmp near 05dfah                           ; e9 19 01
    cmp byte [bp-002h], 008h                  ; 80 7e fe 08
    jc short 05d17h                           ; 72 30
    mov ax, di                                ; 89 f8
    xor dx, dx                                ; 31 d2
    mov bx, cx                                ; 89 cb
    xor cx, cx                                ; 31 c9
    call 0a0c0h                               ; e8 ce 43
    xor bx, bx                                ; 31 db
    add ax, word [bp-006h]                    ; 03 46 fa
    adc dx, bx                                ; 11 da
    mov bx, word [bp-008h]                    ; 8b 5e f8
    xor cx, cx                                ; 31 c9
    call 0a0c0h                               ; e8 bf 43
    xor bx, bx                                ; 31 db
    ...
    mov word [bp+016h], bx                    ; 89 5e 16
    test dl, dl                               ; 84 d2
    je short 05dfah                           ; 74 46
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 64 bb
    mov al, dl                                ; 88 d0
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 90 bb
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 05f40h                           ; e9 5c 01
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 34 bb
    push 0077ah                               ; 68 7a 07
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 6f bb
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 55 b8
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 040h                  ; 3c 40
    jne short 05ea2h                          ; 75 03
    jmp near 05dfah                           ; e9 58 ff
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 0aah                               ; 80 cc aa
    jmp near 05f40h                           ; e9 93 00
    mov al, byte [bp-002h]                    ; 8a 46 fe
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 0a0c0h                               ; e8 e8 41
    mov bx, word [bp-004h]                    ; 8b 5e fc
    xor cx, cx                                ; 31 c9
    call 0a0c0h                               ; e8 e0 41
    mov word [bp-00eh], ax                    ; 89 46 f2
    mov word [bp-00ah], dx                    ; 89 56 f6
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
    ...
    or ah, 003h                               ; 80 cc 03
    mov word [bp+016h], ax                    ; 89 46 16
    jmp near 05dfeh                           ; e9 04 ff
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 1e ba
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 4f ba
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05dfah                           ; e9 dd fe
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 fb b9
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 007c7h                               ; 68 c7 07
    jmp near 05c47h                           ; e9 0f fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 0a b7
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 05e0dh                           ; e9 b2 fe
    pop SS                                    ; 17
    pushaw                                    ; 60
    dec dx                                    ; 4a
    pushaw                                    ; 60
    ...
    dec dx                                    ; 4a
    pushaw                                    ; 60
    cmp sp, word [si-05bh]                    ; 3b 64 a5
    popaw                                     ; 61
    dec dx                                    ; 4a
    pushaw                                    ; 60
    scasb                                     ; ae
    popaw                                     ; 61
    cmp sp, word [si+02fh]                    ; 3b 64 2f
    pushaw                                    ; 60
    das                                       ; 2f
    pushaw                                    ; 60
    das                                       ; 2f
    ...
    das                                       ; 2f
    pushaw                                    ; 60
_int13_harddisk_ext:                         ; 0xf5f7b LB 0x50f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00028h                ; 83 ec 28
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 e2 b6
    mov word [bp-012h], ax                    ; 89 46 ee
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 d6 b6
    mov word [bp-008h], 00122h                ; c7 46 f8 22 01
    mov word [bp-006h], ax                    ; 89 46 fa
    xor bx, bx                                ; 31 db
    mov dx, 0008eh                            ; ba 8e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 b5 b6
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 05fb8h                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 05fd6h                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push 007f5h                               ; 68 f5 07
    push 006b8h                               ; 68 b8 06
    jmp short 05fcbh                          ; eb ce
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    sub bx, strict byte 00041h                ; 83 eb 41
    cmp bx, strict byte 0000fh                ; 83 fb 0f
    jnbe short 0602fh                         ; 77 24
    add bx, bx                                ; 01 db
    mov dx, word [bp+016h]                    ; 8b 56 16
    xor dh, dh                                ; 30 f6
    jmp word [cs:bx+05f5bh]                   ; 2e ff a7 5b 5f
    ...
    jmp near 0643fh                           ; e9 10 04
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 e9 b8
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 007f5h                               ; 68 f5 07
    push 007c7h                               ; 68 c7 07
    jmp near 060dfh                           ; e9 95 00
    ...
    jnbe short 060c7h                         ; 77 22
    jne short 060eah                          ; 75 43
    mov di, word [bp-00ch]                    ; 8b 7e f4
    cmp di, word [es:bx+03ah]                 ; 26 3b 7f 3a
    jnbe short 060c7h                         ; 77 17
    mov di, word [bp-00ch]                    ; 8b 7e f4
    cmp di, word [es:bx+03ah]                 ; 26 3b 7f 3a
    jne short 060eah                          ; 75 31
    cmp cx, word [es:bx+038h]                 ; 26 3b 4f 38
    jnbe short 060c7h                         ; 77 08
    jne short 060eah                          ; 75 29
    cmp dx, word [es:bx+036h]                 ; 26 3b 57 36
    jc short 060eah                           ; 72 23
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 51 b8
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 007f5h                               ; 68 f5 07
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 82 b8
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 06468h                           ; e9 7e 03
    mov di, word [bp+016h]                    ; 8b 7e 16
    shr di, 008h                              ; c1 ef 08
    cmp di, strict byte 00044h                ; 83 ff 44
    je short 060fah                           ; 74 05
    cmp di, strict byte 00047h                ; 83 ff 47
    jne short 060fdh                          ; 75 03
    jmp near 0643bh                           ; e9 3e 03
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx+018h], strict word 00000h ; 26 c7 47 18 00 00
    mov word [es:bx+01ah], strict word 00000h ; 26 c7 47 1a 00 00
    mov word [es:bx+01ch], strict word 00000h ; 26 c7 47 1c 00 00
    ...
    mov word [es:bx+002h], ax                 ; 26 89 47 02
    test dl, dl                               ; 84 d2
    je short 061cch                           ; 74 51
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 9d b7
    mov al, dl                                ; 88 d0
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push di                                   ; 57
    ...
    push 00759h                               ; 68 59 07
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 cf b7
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 06470h                           ; e9 cb 02
    or dh, 0b2h                               ; 80 ce b2
    mov word [bp+016h], dx                    ; 89 56 16
    jmp near 06473h                           ; e9 c5 02
    ...
    mov word [bp-00eh], ax                    ; 89 46 f2
    cmp ax, strict word 0001ah                ; 3d 1a 00
    jnc short 061cfh                          ; 73 06
    jmp near 06468h                           ; e9 9c 02
    jmp near 0643bh                           ; e9 6c 02
    jnc short 061d4h                          ; 73 03
    jmp near 0626bh                           ; e9 97 00
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    les bx, [bp-008h]                         ; c4 5e f8
    ...
    test dl, dl                               ; 84 d2
    jne short 062c6h                          ; 75 04
    xor bx, bx                                ; 31 db
    jmp short 062c9h                          ; eb 03
    mov bx, strict word 00008h                ; bb 08 00
    or bl, 010h                               ; 80 cb 10
    cmp dl, 001h                              ; 80 fa 01
    jne short 062d9h                          ; 75 08
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 062dbh                          ; eb 05
    jmp near 0636ch                           ; e9 93 00
    xor ax, ax                                ; 31 c0
    or bx, ax                                 ; 09 c3
    cmp dl, 003h                              ; 80 fa 03
    jne short 062e7h                          ; 75 05
    mov ax, strict word 00003h                ; b8 03 00
    jmp short 062e9h                          ; eb 02
    xor ax, ax                                ; 31 c0
    or bx, ax                                 ; 09 c3
    mov ax, word [bp-01ch]                    ; 8b 46 e4
    ...
    xor bl, bl                                ; 30 db
    xor bh, bh                                ; 30 ff
    jmp short 0634eh                          ; eb 05
    cmp bh, 00fh                              ; 80 ff 0f
    jnc short 06362h                          ; 73 14
    mov dl, bh                                ; 88 fa
    xor dh, dh                                ; 30 f6
    add dx, 00356h                            ; 81 c2 56 03
    mov ax, word [bp-012h]                    ; 8b 46 ee
    call 01650h                               ; e8 f4 b2
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 06349h                          ; eb e7
    neg bl                                    ; f6 db
    les si, [bp-008h]                         ; c4 76 f8
    mov byte [es:si+00243h], bl               ; 26 88 9c 43 02
    cmp word [bp-00eh], strict byte 00042h    ; 83 7e f2 42
    jnc short 06375h                          ; 73 03
    jmp near 0643bh                           ; e9 c6 00
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    cwd                                       ; 99
    db  02bh, 0c2h
    ...
    jmp short 0641dh                          ; eb 05
    cmp bh, 040h                              ; 80 ff 40
    jnc short 06432h                          ; 73 15
    mov al, bh                                ; 88 f8
    xor ah, ah                                ; 30 e4
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, ax                                ; 01 c2
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01650h                               ; e8 24 b2
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 06418h                          ; eb e6
    neg bl                                    ; f6 db
    mov es, [bp-00ah]                         ; 8e 46 f6
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 14 b2
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    cmp dx, strict byte 00006h                ; 83 fa 06
    je short 0643bh                           ; 74 e4
    cmp dx, strict byte 00001h                ; 83 fa 01
    jc short 06468h                           ; 72 0c
    jbe short 0643bh                          ; 76 dd
    cmp dx, strict byte 00003h                ; 83 fa 03
    jc short 06468h                           ; 72 05
    cmp dx, strict byte 00004h                ; 83 fa 04
    jbe short 0643bh                          ; 76 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 da b1
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 0644eh                          ; eb c4
_int14_function:                             ; 0xf648a LB 0x15c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sti                                       ; fb
    ...
    add dx, dx                                ; 01 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 d2 b1
    mov si, ax                                ; 89 c6
    mov bx, ax                                ; 89 c3
    mov dx, word [bp+00eh]                    ; 8b 56 0e
    add dx, strict byte 0007ch                ; 83 c2 7c
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 a6 b1
    mov cl, al                                ; 88 c1
    cmp word [bp+00eh], strict byte 00004h    ; 83 7e 0e 04
    jnc short 064b6h                          ; 73 04
    test si, si                               ; 85 f6
    jnbe short 064b9h                         ; 77 03
    jmp near 065dch                           ; e9 23 01
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 064cdh                           ; 72 0d
    jbe short 0652dh                          ; 76 6b
    cmp AL, strict byte 003h                  ; 3c 03
    je short 06525h                           ; 74 5f
    cmp AL, strict byte 002h                  ; 3c 02
    je short 06528h                           ; 74 5e
    jmp near 065d6h                           ; e9 09 01
    test al, al                               ; 84 c0
    jne short 0652ah                          ; 75 59
    ...
    jmp near 065b7h                           ; e9 92 00
    jmp near 065c5h                           ; e9 9d 00
    jmp short 0657bh                          ; eb 51
    jmp near 065d6h                           ; e9 a9 00
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 36 b1
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    je short 0655dh                           ; 74 17
    test cl, cl                               ; 84 c9
    je short 0655dh                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 19 b1
    cmp ax, si                                ; 39 f0
    je short 06538h                           ; 74 e1
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 06538h                          ; eb db
    test cl, cl                               ; 84 c9
    je short 06567h                           ; 74 06
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+005h]                         ; 8d 57 05
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cl, cl                               ; 84 c9
    jne short 065b7h                          ; 75 43
    or AL, strict byte 080h                   ; 0c 80
    mov byte [bp+013h], al                    ; 88 46 13
    jmp short 065b7h                          ; eb 3c
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 e8 b0
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 065a7h                          ; 75 17
    test cl, cl                               ; 84 c9
    je short 065a7h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 cf b0
    cmp ax, si                                ; 39 f0
    je short 06586h                           ; 74 e5
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 06586h                          ; eb df
    test cl, cl                               ; 84 c9
    je short 065bdh                           ; 74 12
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov byte [bp+012h], al                    ; 88 46 12
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 065e0h                          ; eb 23
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 06576h                          ; eb b1
    lea dx, [si+005h]                         ; 8d 54 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 065b4h                          ; eb de
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 065e0h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
timer_wait_:                                 ; 0xf65e6 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    jne short 06613h                          ; 75 05
    cmp cx, strict byte 0ffffh                ; 83 f9 ff
    je short 06622h                           ; 74 0f
    mov dx, strict word 00061h                ; ba 61 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jne short 06613h                          ; 75 f3
    jmp short 06603h                          ; eb e1
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop cx                                    ; 59
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
set_enable_a20_:                             ; 0xf6629 LB 0x30
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cl, al                                ; 88 c1
    test bx, bx                               ; 85 db
    je short 06642h                           ; 74 05
    or AL, strict byte 002h                   ; 0c 02
    out DX, AL                                ; ee
    jmp short 06645h                          ; eb 03
    and AL, strict byte 0fdh                  ; 24 fd
    out DX, AL                                ; ee
    test cl, 002h                             ; f6 c1 02
    je short 0664fh                           ; 74 05
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 06651h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_e820_range_:                             ; 0xf6659 LB 0x88
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, dx                                ; 89 d6
    ...
    db  0ebh, 069h, 01ch, 067h, 030h, 067h, 0c5h, 067h, 0cbh, 067h, 0d0h, 067h, 0d5h, 067h, 07dh, 068h
    db  0a8h, 068h, 0beh, 067h, 0beh, 067h, 075h, 069h, 09dh, 069h, 0b0h, 069h, 0bfh, 069h, 0c5h, 067h
    db  0c6h, 069h
_int15_function:                             ; 0xf66e1 LB 0x33c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jnbe short 06726h                         ; 77 35
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00011h                ; b9 11 00
    mov di, 066afh                            ; bf af 66
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov si, word [cs:di+066bfh]               ; 2e 8b b5 bf 66
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    jmp near 069ebh                           ; e9 c2 02
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 06994h                           ; e9 64 02
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 06745h                           ; 72 0e
    jbe short 06759h                          ; 76 20
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 06786h                           ; 74 48
    cmp ax, strict word 00002h                ; 3d 02 00
    je short 06769h                           ; 74 26
    jmp short 06793h                          ; eb 4e
    test ax, ax                               ; 85 c0
    jne short 06793h                          ; 75 4a
    xor ax, ax                                ; 31 c0
    call 06629h                               ; e8 db fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp near 067beh                           ; e9 65 00
    mov ax, strict word 00001h                ; b8 01 00
    call 06629h                               ; e8 ca fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], dh                    ; 88 76 13
    jmp near 067beh                           ; e9 55 00
    mov dx, 00092h                            ; ba 92 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 067beh                           ; e9 38 00
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], ah                    ; 88 66 13
    mov word [bp+00ch], ax                    ; 89 46 0c
    jmp near 067beh                           ; e9 2b 00
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 85 b1
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 0082eh                               ; 68 2e 08
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 ba b1
    add sp, strict byte 00006h                ; 83 c4 06
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    retn                                      ; c3
    mov word [bp+018h], dx                    ; 89 56 18
    jmp near 06877h                           ; e9 ac 00
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 067beh                          ; eb ee
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp short 067bbh                          ; eb e6
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 0684ah                          ; 75 6f
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 6c ae
    test AL, strict byte 001h                 ; a8 01
    jne short 06847h                          ; 75 5f
    mov bx, strict word 00001h                ; bb 01 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 6a ae
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 7a ae
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 6e ae
    mov bx, word [bp+00eh]                    ; 8b 5e 0e
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 62 ae
    mov bx, word [bp+010h]                    ; 8b 5e 10
    mov dx, 0009eh                            ; ba 9e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ah                               ; e8 56 ae
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c7h                               ; e8 83 ae
    jmp near 067beh                           ; e9 77 ff
    jmp near 0698bh                           ; e9 41 01
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 0686bh                          ; 75 1c
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 04 ae
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 48 ae
    mov dl, al                                ; 88 c2
    and dl, 0bfh                              ; 80 e2 bf
    jmp short 0683ch                          ; eb d1
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, bx                                ; 89 d8
    xor ah, bh                                ; 30 fc
    xor bl, bl                                ; 30 db
    ...
    push cx                                   ; 51
    retf                                      ; cb
    jmp near 067beh                           ; e9 49 fe
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 a3 af
    push 0086eh                               ; 68 6e 08
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 de af
    add sp, strict byte 00004h                ; 83 c4 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 067beh                           ; e9 21 fe
    mov word [bp+018h], cx                    ; 89 4e 18
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+00ch], 0e6f5h                ; c7 46 0c f5 e6
    mov word [bp+014h], 0f000h                ; c7 46 14 00 f0
    jmp near 067beh                           ; e9 0e fe
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 b3 ac
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 068a1h                           ; e9 e2 fe
    push 0089dh                               ; 68 9d 08
    push strict byte 00008h                   ; 6a 08
    jmp short 06985h                          ; eb bf
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 069ebh                          ; 75 1f
    mov word [bp+012h], ax                    ; 89 46 12
    mov ax, word [bp+00ch]                    ; 8b 46 0c
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 069e4h                           ; 72 0b
    cmp ax, strict word 00003h                ; 3d 03 00
    jnbe short 069e4h                         ; 77 06
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp near 067beh                           ; e9 da fd
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 067beh                           ; e9 d3 fd
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 2d af
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 008b4h                               ; 68 b4 08
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 62 af
    add sp, strict byte 00008h                ; 83 c4 08
    jmp short 0698bh                          ; eb 82
    xchg word [bp+di-054h], bp                ; 87 6b ac
    imul cx, sp, strict byte 0006bh           ; 6b cc 6b
    sbb bp, word [si+039h]                    ; 1b 6c 39
    insb                                      ; 6c
    push si                                   ; 56
    insb                                      ; 6c
    js short 06a83h                           ; 78 6c
    call far 00b6ch:0d76ch                    ; 9a 6c d7 6c 0b
    insw                                      ; 6d
_int15_function32:                           ; 0xf6a1d LB 0x38a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00008h                ; 83 ec 08
    ...
    jmp near 06c15h                           ; e9 67 01
    cmp dx, strict byte 00020h                ; 83 fa 20
    je short 06abeh                           ; 74 0b
    cmp dx, strict byte 00001h                ; 83 fa 01
    je short 06abbh                           ; 74 03
    jmp near 06bebh                           ; e9 30 01
    jmp near 06d59h                           ; e9 9b 02
    cmp word [bp+01ah], 0534dh                ; 81 7e 1a 4d 53
    jne short 06ab8h                          ; 75 f3
    cmp word [bp+018h], 04150h                ; 81 7e 18 50 41
    jne short 06ab8h                          ; 75 ec
    mov ax, strict word 00035h                ; b8 35 00
    call 016ach                               ; e8 da ab
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    xor dx, dx                                ; 31 d2
    ...
    jc short 06b01h                           ; 72 06
    jne short 06b2fh                          ; 75 32
    test bx, bx                               ; 85 db
    jnbe short 06b2fh                         ; 77 2e
    mov ax, strict word 00031h                ; b8 31 00
    ...
    call 016ach                               ; e8 46 ab
    mov byte [bp-004h], al                    ; 88 46 fc
    mov byte [bp-006h], al                    ; 88 46 fa
    mov ax, word [bp+014h]                    ; 8b 46 14
    cmp ax, strict word 00009h                ; 3d 09 00
    jnbe short 06bebh                         ; 77 77
    mov si, ax                                ; 89 c6
    add si, ax                                ; 01 c6
    mov ax, bx                                ; 89 d8
    add ax, strict word 00000h                ; 05 00 00
    ...
    jmp word [cs:si+06a09h]                   ; 2e ff a4 09 6a
    push strict byte 00001h                   ; 6a 01
    push strict byte 00000h                   ; 6a 00
    push strict byte 00000h                   ; 6a 00
    ...
    call 06659h                               ; e8 c7 f9
    mov word [bp+014h], strict word 00007h    ; c7 46 14 07 00
    jmp near 06ba4h                           ; e9 0a ff
    push strict byte 00002h                   ; 6a 02
    push strict byte 00000h                   ; 6a 00
    push strict byte 00000h                   ; 6a 00
    push strict byte 00000h                   ; 6a 00
    ...
    call 06659h                               ; e8 a7 f9
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06cbfh                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06ccfh                           ; 74 10
    mov word [bp+014h], strict word 00009h    ; c7 46 14 09 00
    jmp near 06ba4h                           ; e9 dd fe
    mov word [bp+014h], strict word 00008h    ; c7 46 14 08 00
    jmp near 06ba4h                           ; e9 d5 fe
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06d3eh                          ; eb 67
    push strict byte 00002h                   ; 6a 02
    push strict byte 00000h                   ; 6a 00
    push strict byte 00000h                   ; 6a 00
    push strict byte 00000h                   ; 6a 00
    ...
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    call 06659h                               ; e8 6b f9
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06cfbh                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06d03h                           ; 74 08
    mov word [bp+014h], strict word 00009h    ; c7 46 14 09 00
    jmp near 06ba4h                           ; e9 a1 fe
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06d3eh                          ; eb 33
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06d17h                          ; 75 06
    cmp word [bp-008h], strict byte 00000h    ; 83 7e f8 00
    je short 06d3eh                           ; 74 27
    push strict byte 00001h                   ; 6a 01
    mov al, byte [bp-006h]                    ; 8a 46 fa
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    ...
    jmp near 06c15h                           ; e9 bc fe
    mov word [bp+028h], bx                    ; 89 5e 28
    mov ax, strict word 00031h                ; b8 31 00
    call 016ach                               ; e8 4a a9
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00030h                ; b8 30 00
    ...
    jbe short 06d81h                          ; 76 05
    mov word [bp+01ch], 03c00h                ; c7 46 1c 00 3c
    mov ax, strict word 00035h                ; b8 35 00
    call 016ach                               ; e8 25 a9
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00034h                ; b8 34 00
    call 016ach                               ; e8 18 a9
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov word [bp+020h], ax                    ; 89 46 20
    mov word [bp+014h], dx                    ; 89 56 14
    jmp near 06c15h                           ; e9 6e fe
_int15_blkmove:                              ; 0xf6da7 LB 0x188
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_inv_op_handler:                             ; 0xf6f2f LB 0x19b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 06f45h                          ; 75 06
    inc word [bp+018h]                        ; ff 46 18
    jmp near 070c3h                           ; e9 7e 01
    cmp word [es:bx], 0050fh                  ; 26 81 3f 0f 05
    je short 06f4fh                           ; 74 03
    jmp near 070bfh                           ; e9 70 01
    ...
    loop 06fa0h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06faeh                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06fb3h                           ; 74 05
    ...
    loop 06fc9h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06fd7h                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06fdbh                           ; 74 04
    ...
    je near 0707ch                            ; 0f 84 02 00
    mov es, ax                                ; 8e c0
    test cx, strict word 00002h               ; f7 c1 02 00
    je near 070a4h                            ; 0f 84 20 00
    ...
    iret                                      ; cf
    jmp short 070c3h                          ; eb 04
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 070c0h                          ; eb fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
init_rtc_:                                   ; 0xf70ca LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, strict word 0000ah                ; b8 0a 00
    call 016c7h                               ; e8 f0 a5
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c7h                               ; e8 e7 a5
    mov ax, strict word 0000ch                ; b8 0c 00
    call 016ach                               ; e8 c6 a5
    mov ax, strict word 0000dh                ; b8 0d 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
rtc_updating_:                               ; 0xf70f2 LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, 061a8h                            ; ba a8 61
    dec dx                                    ; 4a
    je short 0710ah                           ; 74 0e
    mov ax, strict word 0000ah                ; b8 0a 00
    call 016ach                               ; e8 aa a5
    test AL, strict byte 080h                 ; a8 80
    jne short 070f9h                          ; 75 f3
    xor ax, ax                                ; 31 c0
    jmp short 0710dh                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
_int70_function:                             ; 0xf7113 LB 0xbf
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 8e a5
    mov bl, al                                ; 88 c3
    mov byte [bp-004h], al                    ; 88 46 fc
    mov ax, strict word 0000ch                ; b8 0c 00
    call 016ach                               ; e8 83 a5
    mov dl, al                                ; 88 c2
    test bl, 060h                             ; f6 c3 60
    jne short 07133h                          ; 75 03
    jmp near 071b9h                           ; e9 86 00
    test AL, strict byte 020h                 ; a8 20
    je short 0713bh                           ; 74 04
    sti                                       ; fb
    int 04ah                                  ; cd 4a
    cli                                       ; fa
    test dl, 040h                             ; f6 c2 40
    je short 071a3h                           ; 74 63
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01650h                               ; e8 07 a5
    test al, al                               ; 84 c0
    je short 071b9h                           ; 74 6c
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01688h                               ; e8 32 a5
    test dx, dx                               ; 85 d2
    jne short 071a5h                          ; 75 4b
    cmp ax, 003d1h                            ; 3d d1 03
    jnc short 071a5h                          ; 73 46
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 04 a5
    mov si, ax                                ; 89 c6
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 f9 a4
    mov cx, ax                                ; 89 c1
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 de a4
    mov dl, byte [bp-004h]                    ; 8a 56 fc
    and dl, 037h                              ; 80 e2 37
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c7h                               ; e8 39 a5
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01650h                               ; e8 bb a4
    mov bl, al                                ; 88 c3
    or bl, 080h                               ; 80 cb 80
    xor bh, bh                                ; 30 ff
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 0165eh                               ; e8 bb a4
    jmp short 071b9h                          ; eb 14
    mov bx, ax                                ; 89 c3
    ...
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0169ah                               ; e8 e1 a4
    call 0e030h                               ; e8 74 6e
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    call 08136h                               ; e8 71 0f
    jc short 071fbh                           ; 72 34
    jc short 07239h                           ; 72 70
    jc short 0718dh                           ; 72 c2
    jc short 071c6h                           ; 72 f9
    jc short 0720fh                           ; 72 40
    jnc short 0716ch                          ; 73 9b
    db  073h
_int1a_function:                             ; 0xf71d2 LB 0x1d9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sti                                       ; fb
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe short 0723bh                         ; 77 5e
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    add bx, bx                                ; 01 db
    jmp word [cs:bx+071c2h]                   ; 2e ff a7 c2 71
    cli                                       ; fa
    ...
    sti                                       ; fb
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 0723bh                          ; eb 07
    call 070f2h                               ; e8 bb fe
    test ax, ax                               ; 85 c0
    je short 0723eh                           ; 74 03
    jmp near 0726ch                           ; e9 2e 00
    xor ax, ax                                ; 31 c0
    call 016ach                               ; e8 69 a4
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00002h                ; b8 02 00
    call 016ach                               ; e8 60 a4
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00004h                ; b8 04 00
    call 016ach                               ; e8 57 a4
    mov dl, al                                ; 88 c2
    mov byte [bp+011h], al                    ; 88 46 11
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 4c a4
    and AL, strict byte 001h                  ; 24 01
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    call 070f2h                               ; e8 7f fe
    test ax, ax                               ; 85 c0
    je short 0727ah                           ; 74 03
    call 070cah                               ; e8 50 fe
    mov dl, byte [bp+00fh]                    ; 8a 56 0f
    xor dh, dh                                ; 30 f6
    xor ax, ax                                ; 31 c0
    call 016c7h                               ; e8 43 a4
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00002h                ; b8 02 00
    call 016c7h                               ; e8 38 a4
    mov dl, byte [bp+011h]                    ; 8a 56 11
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00004h                ; b8 04 00
    call 016c7h                               ; e8 2d a4
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 0c a4
    mov bl, al                                ; 88 c3
    ...
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c7h                               ; e8 0e a4
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov byte [bp+012h], bl                    ; 88 5e 12
    jmp short 0726ch                          ; eb aa
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    call 070f2h                               ; e8 29 fe
    test ax, ax                               ; 85 c0
    je short 072cfh                           ; 74 02
    jmp short 0726ch                          ; eb 9d
    mov ax, strict word 00009h                ; b8 09 00
    call 016ach                               ; e8 d7 a3
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00008h                ; b8 08 00
    call 016ach                               ; e8 ce a3
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00007h                ; b8 07 00
    call 016ach                               ; e8 c5 a3
    mov byte [bp+00eh], al                    ; 88 46 0e
    mov ax, strict word 00032h                ; b8 32 00
    call 016ach                               ; e8 bc a3
    mov byte [bp+011h], al                    ; 88 46 11
    mov byte [bp+012h], al                    ; 88 46 12
    jmp near 0726ch                           ; e9 73 ff
    call 070f2h                               ; e8 f6 fd
    test ax, ax                               ; 85 c0
    je short 07306h                           ; 74 06
    call 070cah                               ; e8 c7 fd
    jmp near 0726ch                           ; e9 66 ff
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00009h                ; b8 09 00
    call 016c7h                               ; e8 b6 a3
    mov dl, byte [bp+00fh]                    ; 8a 56 0f
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00008h                ; b8 08 00
    call 016c7h                               ; e8 ab a3
    mov dl, byte [bp+00eh]                    ; 8a 56 0e
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00007h                ; b8 07 00
    call 016c7h                               ; e8 a0 a3
    mov dl, byte [bp+011h]                    ; 8a 56 11
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00032h                ; b8 32 00
    call 016c7h                               ; e8 95 a3
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 74 a3
    mov bl, al                                ; 88 c3
    and bl, 07fh                              ; 80 e3 7f
    jmp near 072afh                           ; e9 6f ff
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 66 a3
    mov bl, al                                ; 88 c3
    mov word [bp+012h], strict word 00000h    ; c7 46 12 00 00
    test AL, strict byte 020h                 ; a8 20
    je short 07354h                           ; 74 03
    jmp near 0726ch                           ; e9 18 ff
    call 070f2h                               ; e8 9b fd
    test ax, ax                               ; 85 c0
    je short 0735eh                           ; 74 03
    call 070cah                               ; e8 6c fd
    mov dl, byte [bp+00fh]                    ; 8a 56 0f
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00001h                ; b8 01 00
    call 016c7h                               ; e8 5e a3
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00003h                ; b8 03 00
    call 016c7h                               ; e8 53 a3
    mov dl, byte [bp+011h]                    ; 8a 56 11
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00005h                ; b8 05 00
    call 016c7h                               ; e8 48 a3
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c7h                               ; e8 2f a3
    jmp near 0726ch                           ; e9 d1 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016ach                               ; e8 0b a3
    mov bl, al                                ; 88 c3
    mov dl, al                                ; 88 c2
    and dl, 057h                              ; 80 e2 57
    jmp near 072b1h                           ; e9 06 ff
send_to_mouse_ctrl_:                         ; 0xf73ab LB 0x34
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 073cah                           ; 74 0e
    push 008eeh                               ; 68 ee 08
    push 01168h                               ; 68 68 11
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 9f a5
    add sp, strict byte 00006h                ; 83 c4 06
...
get_mouse_data_:                             ; 0xf73df LB 0x5d
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_kbd_command_byte_:                       ; 0xf743c LB 0x32
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 0745bh                           ; 74 0e
    push 008f8h                               ; 68 f8 08
    push 01168h                               ; 68 68 11
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 0e a5
    add sp, strict byte 00006h                ; 83 c4 06
    mov AL, strict byte 060h                  ; b0 60
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int74_function:                             ; 0xf746e LB 0xd2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00008h                ; 83 ec 08
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 ef a1
    mov cx, ax                                ; 89 c1
    mov word [bp+004h], strict word 00000h    ; c7 46 04 00 00
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    test AL, strict byte 080h                 ; a8 80
    jne short 074b5h                          ; 75 03
    jmp near 0752ch                           ; e9 77 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    mov byte [bp-004h], al                    ; 88 46 fc
    mov al, byte [bp-002h]                    ; 8a 46 fe
    ...
    je short 0751fh                           ; 74 0a
    mov word [bp+004h], strict word 00001h    ; c7 46 04 01 00
    jmp short 0751fh                          ; eb 03
    inc byte [bp-002h]                        ; fe 46 fe
    mov bl, byte [bp-002h]                    ; 8a 5e fe
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0165eh                               ; e8 32 a1
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    xor word [di-001h], strict byte 00075h    ; 83 75 ff 75
    jl short 075ach                           ; 7c 76
    adc word [bx+07dh], si                    ; 11 77 7d
    jnbe short 07505h                         ; 77 ca
    jne short 074e2h                          ; 75 a5
    jnbe short 075a9h                         ; 77 6a
    db  078h
_int15_function_mouse:                       ; 0xf7540 LB 0x38d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00006h                ; 83 ec 06
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 1c a1
    mov cx, ax                                ; 89 c1
    cmp byte [bp+012h], 007h                  ; 80 7e 12 07
    jbe short 07563h                          ; 76 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp near 078c7h                           ; e9 64 03
    mov ax, strict word 00065h                ; b8 65 00
    call 0743ch                               ; e8 d3 fe
    and word [bp+018h], strict byte 0fffeh    ; 83 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov al, byte [bp+012h]                    ; 8a 46 12
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe short 075d8h                         ; 77 60
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    add si, ax                                ; 01 c6
    jmp word [cs:si+07530h]                   ; 2e ff a4 30 75
    cmp byte [bp+00dh], 001h                  ; 80 7e 0d 01
    jnbe short 075dbh                         ; 77 52
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01650h                               ; e8 bf a0
    test AL, strict byte 080h                 ; a8 80
    jne short 075a0h                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 005h                  ; c6 46 13 05
    jmp near 078c1h                           ; e9 21 03
    cmp byte [bp+00dh], 000h                  ; 80 7e 0d 00
    jne short 075aah                          ; 75 04
    mov AL, strict byte 0f5h                  ; b0 f5
    jmp short 075ach                          ; eb 02
    mov AL, strict byte 0f4h                  ; b0 f4
    xor ah, ah                                ; 30 e4
    call 073abh                               ; e8 fa fd
    test al, al                               ; 84 c0
    jne short 075deh                          ; 75 29
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 22 fe
    test al, al                               ; 84 c0
    je short 075c7h                           ; 74 06
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    jne short 075deh                          ; 75 17
    jmp near 078c1h                           ; e9 f7 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 075d5h                           ; 72 04
    cmp AL, strict byte 008h                  ; 3c 08
    jbe short 075e1h                          ; 76 0c
    jmp near 07773h                           ; e9 9b 01
    jmp near 078aeh                           ; e9 d3 02
    jmp near 078b9h                           ; e9 db 02
    jmp near 07845h                           ; e9 64 02
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01650h                               ; e8 67 a0
    ...
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0165eh                               ; e8 5f a0
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01650h                               ; e8 49 a0
    mov bl, al                                ; 88 c3
    and bl, 0f8h                              ; 80 e3 f8
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0165eh                               ; e8 48 a0
    mov ax, 000ffh                            ; b8 ff 00
    call 073abh                               ; e8 8f fd
    test al, al                               ; 84 c0
    jne short 075deh                          ; 75 be
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073dfh                               ; e8 b7 fd
    mov cl, al                                ; 88 c1
    cmp byte [bp-004h], 0feh                  ; 80 7e fc fe
    jne short 0763ah                          ; 75 0a
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 004h                  ; c6 46 13 04
    jmp short 075c7h                          ; eb 8d
    cmp byte [bp-004h], 0fah                  ; 80 7e fc fa
    je short 07651h                           ; 74 11
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 00903h                               ; 68 03 09
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 18 a3
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 075deh                          ; 75 89
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 82 fd
    test al, al                               ; 84 c0
    jne short 076b7h                          ; 75 56
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073dfh                               ; e8 76 fd
    test al, al                               ; 84 c0
    jne short 076b7h                          ; 75 4a
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00dh], al                    ; 88 46 0d
    jmp near 078c1h                           ; e9 45 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 003h                  ; 3c 03
    jc short 07693h                           ; 72 10
    jbe short 076b1h                          ; 76 2c
    cmp AL, strict byte 006h                  ; 3c 06
    je short 076c6h                           ; 74 3d
    cmp AL, strict byte 005h                  ; 3c 05
    je short 076c0h                           ; 74 33
    cmp AL, strict byte 004h                  ; 3c 04
    je short 076bah                           ; 74 29
    jmp short 076cch                          ; eb 39
    cmp AL, strict byte 002h                  ; 3c 02
    je short 076abh                           ; 74 14
    cmp AL, strict byte 001h                  ; 3c 01
    je short 076a5h                           ; 74 0a
    test al, al                               ; 84 c0
    jne short 076cch                          ; 75 2d
    mov byte [bp-008h], 00ah                  ; c6 46 f8 0a
    jmp short 076d0h                          ; eb 2b
    mov byte [bp-008h], 014h                  ; c6 46 f8 14
    jmp short 076d0h                          ; eb 25
    mov byte [bp-008h], 028h                  ; c6 46 f8 28
    jmp short 076d0h                          ; eb 1f
    mov byte [bp-008h], 03ch                  ; c6 46 f8 3c
    jmp short 076d0h                          ; eb 19
    jmp near 07845h                           ; e9 8b 01
    mov byte [bp-008h], 050h                  ; c6 46 f8 50
    jmp short 076d0h                          ; eb 10
    mov byte [bp-008h], 064h                  ; c6 46 f8 64
    jmp short 076d0h                          ; eb 0a
    mov byte [bp-008h], 0c8h                  ; c6 46 f8 c8
    jmp short 076d0h                          ; eb 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jbe short 07706h                          ; 76 30
    mov ax, 000f3h                            ; b8 f3 00
    call 073abh                               ; e8 cf fc
    test al, al                               ; 84 c0
    jne short 076fbh                          ; 75 1b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073dfh                               ; e8 f7 fc
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    call 073abh                               ; e8 bb fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073dfh                               ; e8 e7 fc
    jmp near 078c1h                           ; e9 c6 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 078c1h                           ; e9 bb 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 078c1h                           ; e9 b0 01
    cmp byte [bp+00dh], 004h                  ; 80 7e 0d 04
    jnc short 07773h                          ; 73 5c
    mov ax, 000e8h                            ; b8 e8 00
    call 073abh                               ; e8 8e fc
    test al, al                               ; 84 c0
    jne short 07769h                          ; 75 48
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 b6 fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 07740h                           ; 74 11
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 0092eh                               ; 68 2e 09
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 29 a2
    add sp, strict byte 00006h                ; 83 c4 06
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    xor ah, ah                                ; 30 e4
    call 073abh                               ; e8 63 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 8f fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 077a2h                           ; 74 4c
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 0092eh                               ; 68 2e 09
    ...
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 077a2h                          ; eb 39
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 077a2h                          ; eb 2f
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp short 077a2h                          ; eb 25
    mov ax, 000f2h                            ; b8 f2 00
    call 073abh                               ; e8 28 fc
    test al, al                               ; 84 c0
    jne short 0779ah                          ; 75 13
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 50 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073dfh                               ; e8 48 fc
    jmp near 07673h                           ; e9 d9 fe
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 078c1h                           ; e9 1c 01
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    test al, al                               ; 84 c0
    jbe short 077b3h                          ; 76 07
    cmp AL, strict byte 002h                  ; 3c 02
    jbe short 0781ah                          ; 76 6a
    jmp near 0784fh                           ; e9 9c 00
    mov ax, 000e9h                            ; b8 e9 00
    call 073abh                               ; e8 f2 fb
    test al, al                               ; 84 c0
    jne short 07823h                          ; 75 66
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 1a fc
    mov cl, al                                ; 88 c1
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 077deh                           ; 74 11
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 0092eh                               ; 68 2e 09
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 8b a1
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 07845h                          ; 75 63
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 f5 fb
    test al, al                               ; 84 c0
    jne short 07845h                          ; 75 57
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073dfh                               ; e8 e9 fb
    test al, al                               ; 84 c0
    jne short 07845h                          ; 75 4b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073dfh                               ; e8 dd fb
    test al, al                               ; 84 c0
    jne short 07845h                          ; 75 3f
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+010h], al                    ; 88 46 10
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp short 077a2h                          ; eb 88
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 07825h                          ; 75 07
    mov ax, 000e6h                            ; b8 e6 00
    jmp short 07828h                          ; eb 05
    jmp short 07845h                          ; eb 20
    mov ax, 000e7h                            ; b8 e7 00
    call 073abh                               ; e8 80 fb
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    jne short 07841h                          ; 75 10
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073dfh                               ; e8 a6 fb
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 07841h                           ; 74 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je short 078ach                           ; 74 67
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 078ach                          ; eb 5d
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 0095ah                               ; 68 5a 09
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 09 a1
    add sp, strict byte 00006h                ; 83 c4 06
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp short 078c1h                          ; eb 57
    mov si, word [bp+00ch]                    ; 8b 76 0c
    mov bx, si                                ; 89 f3
    mov dx, strict word 00022h                ; ba 22 00
    mov ax, cx                                ; 89 c8
    call 0167ah                               ; e8 03 9e
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, strict word 00024h                ; ba 24 00
    mov ax, cx                                ; 89 c8
    call 0167ah                               ; e8 f8 9d
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01650h                               ; e8 c6 9d
    mov ah, al                                ; 88 c4
    test si, si                               ; 85 f6
    jne short 0789eh                          ; 75 0e
    cmp word [bp+014h], strict byte 00000h    ; 83 7e 14 00
    jne short 0789eh                          ; 75 08
    test AL, strict byte 080h                 ; a8 80
    je short 078a0h                           ; 74 06
    and AL, strict byte 07fh                  ; 24 7f
    jmp short 078a0h                          ; eb 02
    or AL, strict byte 080h                   ; 0c 80
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0165eh                               ; e8 b2 9d
    jmp short 078c1h                          ; eb 13
    push 00974h                               ; 68 74 09
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 b0 a0
    add sp, strict byte 00004h                ; 83 c4 04
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    mov ax, strict word 00047h                ; b8 47 00
    call 0743ch                               ; e8 75 fb
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
_int17_function:                             ; 0xf78cd LB 0xaf
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    ...
    add dx, strict byte 00008h                ; 83 c2 08
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 8b 9d
    mov bx, ax                                ; 89 c3
    mov si, ax                                ; 89 c6
    cmp byte [bp+013h], 003h                  ; 80 7e 13 03
    jnc short 078f7h                          ; 73 0c
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    cmp ax, strict word 00003h                ; 3d 03 00
    jnc short 078f7h                          ; 73 04
    test bx, bx                               ; 85 db
    jnbe short 078fah                         ; 77 03
    jmp near 07972h                           ; e9 78 00
    mov dx, ax                                ; 89 c2
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 040h                 ; a8 40
    je short 0793eh                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 0793eh                           ; 74 03
    dec cx                                    ; 49
    jmp short 0792dh                          ; eb ef
    cmp byte [bp+013h], 001h                  ; 80 7e 13 01
    jne short 07959h                          ; 75 15
    lea dx, [si+002h]                         ; 8d 54 02
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cx, cx                               ; 85 c9
    jne short 0796ch                          ; 75 04
    or byte [bp+013h], 001h                   ; 80 4e 13 01
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 07976h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
wait_:                                       ; 0xf797c LB 0xaf
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 01688h                               ; e8 e9 9c
    mov word [bp-010h], ax                    ; 89 46 f0
    mov bx, dx                                ; 89 d3
    hlt                                       ; f4
    mov dx, 0046ch                            ; ba 6c 04
    xor ax, ax                                ; 31 c0
    call 01688h                               ; e8 db 9c
    mov word [bp-012h], ax                    ; 89 46 ee
    mov di, dx                                ; 89 d7
    cmp dx, bx                                ; 39 da
    jnbe short 079bdh                         ; 77 07
    jne short 079c4h                          ; 75 0c
    cmp ax, word [bp-010h]                    ; 3b 46 f0
    jbe short 079c4h                          ; 76 07
    sub ax, word [bp-010h]                    ; 2b 46 f0
    sbb dx, bx                                ; 19 da
    jmp short 079cfh                          ; eb 0b
    cmp dx, bx                                ; 39 da
    jc short 079cfh                           ; 72 07
    jne short 079d3h                          ; 75 09
    cmp ax, word [bp-010h]                    ; 3b 46 f0
    jnc short 079d3h                          ; 73 04
    sub si, ax                                ; 29 c6
    sbb cx, dx                                ; 19 d1
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-010h], ax                    ; 89 46 f0
    ...
    int 016h                                  ; cd 16
    je short 079e7h                           ; 74 05
    mov AL, strict byte 001h                  ; b0 01
    jmp near 079e9h                           ; e9 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    test al, al                               ; 84 c0
    je short 07a10h                           ; 74 23
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    int 016h                                  ; cd 16
    xchg ah, al                               ; 86 c4
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 63 9f
    add sp, strict byte 00006h                ; 83 c4 06
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    je short 07a10h                           ; 74 04
    mov al, dl                                ; 88 d0
    jmp short 07a22h                          ; eb 12
    test cx, cx                               ; 85 c9
    jnle short 079a4h                         ; 7f 90
    jne short 07a1ah                          ; 75 04
    test si, si                               ; 85 f6
    jnbe short 079a4h                         ; 77 8a
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    push ax                                   ; 50
    popfw                                     ; 9d
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_byte_:                             ; 0xf7a2b LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_word_:                             ; 0xf7a41 LB 0x14
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
print_detected_harddisks_:                   ; 0xf7a55 LB 0x13a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 04 9c
    mov si, ax                                ; 89 c6
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    xor cl, cl                                ; 30 c9
    xor ch, ch                                ; 30 ed
    mov dx, 00304h                            ; ba 04 03
    call 01650h                               ; e8 d8 9b
    mov byte [bp-00ch], al                    ; 88 46 f4
    xor bl, bl                                ; 30 db
    cmp bl, byte [bp-00ch]                    ; 3a 5e f4
    jnc short 07adfh                          ; 73 5d
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    add dx, 00305h                            ; 81 c2 05 03
    mov ax, si                                ; 89 f0
    call 01650h                               ; e8 bf 9b
    mov bh, al                                ; 88 c7
    cmp AL, strict byte 00ch                  ; 3c 0c
    jc short 07abch                           ; 72 25
    test cl, cl                               ; 84 c9
    jne short 07aa8h                          ; 75 0d
    push 009a7h                               ; 68 a7 09
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 c3 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    ...
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 07b5ch                           ; e9 a0 00
    cmp AL, strict byte 008h                  ; 3c 08
    jc short 07ad3h                           ; 72 13
    test ch, ch                               ; 84 ed
    jne short 07ad1h                          ; 75 0d
    push 009cfh                               ; 68 cf 09
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 9a 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov CH, strict byte 001h                  ; b5 01
    jmp short 07aa8h                          ; eb d5
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 07af3h                          ; 73 1c
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 07ae2h                           ; 74 05
    jmp short 07af3h                          ; eb 14
    jmp near 07b61h                           ; e9 7f 00
    push 009e4h                               ; 68 e4 09
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 7c 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp-00eh], 001h                  ; c6 46 f2 01
    jmp short 07b09h                          ; eb 16
    cmp bh, 004h                              ; 80 ff 04
    jc short 07b09h                           ; 72 11
    test cl, cl                               ; 84 c9
    jne short 07b09h                          ; 75 0d
    push 009f6h                               ; 68 f6 09
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 62 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    ...
    idiv di                                   ; f7 ff
    test dx, dx                               ; 85 d2
    je short 07b52h                           ; 74 05
    push 00a28h                               ; 68 28 0a
    jmp short 07b55h                          ; eb 03
    push 00a2eh                               ; 68 2e 0a
    push di                                   ; 57
    call 01966h                               ; e8 0d 9e
    add sp, strict byte 00004h                ; 83 c4 04
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    jmp near 07a7dh                           ; e9 1c ff
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    jne short 07b7ah                          ; 75 13
    test cl, cl                               ; 84 c9
    jne short 07b7ah                          ; 75 0f
    test ch, ch                               ; 84 ed
    jne short 07b7ah                          ; 75 0b
    push 00a35h                               ; 68 35 0a
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 ef 9d
    add sp, strict byte 00004h                ; 83 c4 04
    push 00a49h                               ; 68 49 0a
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 e4 9d
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_boot_drive_:                             ; 0xf7b8f LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 cd 9a
    mov dx, 00304h                            ; ba 04 03
    call 01650h                               ; e8 ab 9a
    sub bl, 002h                              ; 80 eb 02
    cmp bl, al                                ; 38 c3
    jc short 07baeh                           ; 72 02
...
show_logo_:                                  ; 0xf7bb7 LB 0x231
    ...
    mov al, dl                                ; 88 d0
    xor ah, ah                                ; 30 e4
    call 07a41h                               ; e8 5d fe
    cmp ax, 066bbh                            ; 3d bb 66
    jne short 07bfbh                          ; 75 12
    push SS                                   ; 16
    pop ES                                    ; 07
    ...
    je short 07bfeh                           ; 74 03
    jmp near 07cc6h                           ; e9 c8 00
    mov al, dl                                ; 88 d0
    add AL, strict byte 004h                  ; 04 04
    xor ah, ah                                ; 30 e4
    call 07a2bh                               ; e8 24 fe
    mov ch, al                                ; 88 c5
    mov byte [bp-012h], al                    ; 88 46 ee
    mov al, dl                                ; 88 d0
    add AL, strict byte 005h                  ; 04 05
    xor ah, ah                                ; 30 e4
    call 07a2bh                               ; e8 16 fe
    mov dh, al                                ; 88 c6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 07a41h                               ; e8 1e fe
    mov bx, ax                                ; 89 c3
    mov word [bp-014h], ax                    ; 89 46 ec
    mov al, dl                                ; 88 d0
    add AL, strict byte 006h                  ; 04 06
    xor ah, ah                                ; 30 e4
    call 07a2bh                               ; e8 fa fd
    mov byte [bp-00eh], al                    ; 88 46 f2
    test ch, ch                               ; 84 ed
    jne short 07c40h                          ; 75 08
    test dh, dh                               ; 84 f6
    jne short 07c40h                          ; 75 04
    test bx, bx                               ; 85 db
    je short 07bfbh                           ; 74 bb
    mov bx, 00142h                            ; bb 42 01
    mov ax, 04f02h                            ; b8 02 4f
    int 010h                                  ; cd 10
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    je short 07c71h                           ; 74 23
    xor bx, bx                                ; 31 db
    jmp short 07c58h                          ; eb 06
    inc bx                                    ; 43
    cmp bx, strict byte 00010h                ; 83 fb 10
    jnbe short 07c78h                         ; 77 20
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 0797ch                               ; e8 13 fd
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07c52h                          ; 75 e5
    mov CL, strict byte 001h                  ; b1 01
    jmp short 07c78h                          ; eb 07
    mov ax, 00210h                            ; b8 10 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    test cl, cl                               ; 84 c9
    jne short 07c8eh                          ; 75 12
    mov ax, word [bp-014h]                    ; 8b 46 ec
    shr ax, 004h                              ; c1 e8 04
    mov dx, strict word 00001h                ; ba 01 00
    call 0797ch                               ; e8 f4 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07c8eh                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    je short 07cbbh                           ; 74 27
    test cl, cl                               ; 84 c9
    jne short 07cbbh                          ; 75 23
    mov bx, strict word 00010h                ; bb 10 00
    jmp short 07ca2h                          ; eb 05
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 07cc6h                          ; 76 24
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 0797ch                               ; e8 c9 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07c9dh                          ; 75 e6
    mov CL, strict byte 001h                  ; b1 01
    jmp short 07cc6h                          ; eb 0b
    test cl, cl                               ; 84 c9
    jne short 07cc6h                          ; 75 07
    ...
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0165eh                               ; e8 8e 99
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 07cf0h                           ; 74 14
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    jne short 07d17h                          ; 75 35
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    jne short 07d17h                          ; 75 2f
    cmp word [bp-014h], strict byte 00000h    ; 83 7e ec 00
    je short 07cf3h                           ; 74 05
    jmp short 07d17h                          ; eb 27
    jmp near 07dcbh                           ; e9 d8 00
    cmp byte [bp-00eh], 002h                  ; 80 7e f2 02
    jne short 07d04h                          ; 75 0b
    push 00a4bh                               ; 68 4b 0a
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 65 9c
    add sp, strict byte 00004h                ; 83 c4 04
    test cl, cl                               ; 84 c9
    jne short 07d17h                          ; 75 0f
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, 000c0h                            ; b8 c0 00
    call 0797ch                               ; e8 6b fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07d17h                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je short 07cf0h                           ; 74 d5
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    mov ax, 00100h                            ; b8 00 01
    ...
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 22 9c
    add sp, strict byte 00004h                ; 83 c4 04
    call 07a55h                               ; e8 0b fd
    push 00ab1h                               ; 68 b1 0a
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 14 9c
    add sp, strict byte 00004h                ; 83 c4 04
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0797ch                               ; e8 1e fc
    mov bl, al                                ; 88 c3
    test al, al                               ; 84 c0
    je short 07d55h                           ; 74 f1
    cmp AL, strict byte 030h                  ; 3c 30
    je short 07db8h                           ; 74 50
    cmp bl, 002h                              ; 80 fb 02
    jc short 07d91h                           ; 72 24
    cmp bl, 009h                              ; 80 fb 09
    jnbe short 07d91h                         ; 77 1f
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 07b8fh                               ; e8 16 fe
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 07d7fh                          ; 75 02
    jmp short 07d55h                          ; eb d6
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, si                                ; 89 f0
    call 0165eh                               ; e8 d3 98
    mov byte [bp-00ch], 002h                  ; c6 46 f4 02
    jmp short 07db8h                          ; eb 27
    cmp bl, 02eh                              ; 80 fb 2e
    je short 07da6h                           ; 74 10
    cmp bl, 026h                              ; 80 fb 26
    je short 07dach                           ; 74 11
    cmp bl, 021h                              ; 80 fb 21
    jne short 07db2h                          ; 75 12
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07db8h                          ; eb 12
    mov byte [bp-00ch], 003h                  ; c6 46 f4 03
    jmp short 07db8h                          ; eb 0c
    mov byte [bp-00ch], 004h                  ; c6 46 f4 04
    jmp short 07db8h                          ; eb 06
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07d55h                           ; 74 9d
    mov bl, byte [bp-00ch]                    ; 8a 5e f4
    xor bh, bh                                ; 30 ff
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0165eh                               ; e8 99 98
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    mov AL, strict byte 034h                  ; b0 34
...
delay_boot_:                                 ; 0xf7de8 LB 0x6b
    ...
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 5b 9b
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, dx                                ; 89 d3
    test bx, bx                               ; 85 db
    jbe short 07e2bh                          ; 76 17
    push bx                                   ; 53
    push 00b19h                               ; 68 19 0b
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 49 9b
    add sp, strict byte 00006h                ; 83 c4 06
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 0797ch                               ; e8 54 fb
    dec bx                                    ; 4b
    jmp short 07e10h                          ; eb e5
    push 00a49h                               ; 68 49 0a
    push strict byte 00002h                   ; 6a 02
    call 01966h                               ; e8 33 9b
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 034h                  ; b0 34
    out strict byte 043h, AL                  ; e6 43
    db  033h, 0c0h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_cmd_data_in_:                           ; 0xf7e53 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07e69h                          ; 75 f7
    mov al, byte [bp+004h]                    ; 8a 46 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne short 07e7dh                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 07e7fh                          ; eb 02
    xor ah, ah                                ; 30 e4
    mov di, ax                                ; 89 c7
    mov ax, bx                                ; 89 d8
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
scsi_cmd_data_out_:                          ; 0xf7f28 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07f3eh                          ; 75 f7
    mov al, byte [bp+004h]                    ; 8a 46 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne short 07f52h                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 07f54h                          ; eb 02
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    mov ax, bx                                ; 89 d8
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07f8eh                          ; eb e9
    lea dx, [di+001h]                         ; 8d 55 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07fb4h                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 07fcfh                          ; 76 1b
    mov cx, 08000h                            ; b9 00 80
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07fd7h                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 07ff2h                           ; 74 0e
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
@scsi_read_sectors:                          ; 0xf7ffd LB 0xe0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 08029h                          ; 76 11
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 00b1eh                               ; 68 1e 0b
    push 00b30h                               ; 68 30 0b
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 40 99
    add sp, strict byte 00008h                ; 83 c4 08
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    call 07e53h                               ; e8 9e fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 080d0h                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@scsi_write_sectors:                         ; 0xf80dd LB 0xe0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 08109h                          ; 76 11
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 00b4fh                               ; 68 4f 0b
    push 00b30h                               ; 68 30 0b
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 60 98
    add sp, strict byte 00008h                ; 83 c4 08
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    mov cx, ss                                ; 8c d1
    lea bx, [bp-01ah]                         ; 8d 5e e6
    call 07f28h                               ; e8 93 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 081b0h                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    mov word [es:si+018h], di                 ; 26 89 7c 18
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    mov word [es:si+01ah], dx                 ; 26 89 54 1a
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
scsi_cmd_packet_:                            ; 0xf81bd LB 0x168
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 93 94
    mov si, 00122h                            ; be 22 01
    mov word [bp-00ah], ax                    ; 89 46 f6
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08204h                          ; 75 1f
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 33 97
    push 00b62h                               ; 68 62 0b
    push 00b72h                               ; 68 72 0b
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 6b 97
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 0831ah                           ; e9 16 01
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 0827eh                          ; eb e9
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 08295h                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    ...
    ; sub ah, ah                                ; 2a e4
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 0831ah                          ; eb 6a
    mov ax, word [bp+004h]                    ; 8b 46 04
    test ax, ax                               ; 85 c0
    je short 082bfh                           ; 74 08
    lea dx, [bx+001h]                         ; 8d 57 01
    mov cx, ax                                ; 89 c1
    in AL, DX                                 ; ec
    loop 082bch                               ; e2 fd
    ...
    cmp word [bp+008h], strict byte 00000h    ; 83 7e 08 00
    jne short 082e0h                          ; 75 07
    cmp word [bp+006h], 08000h                ; 81 7e 06 00 80
    jbe short 082fdh                          ; 76 1d
    mov dx, ax                                ; 89 c2
    mov cx, 08000h                            ; b9 00 80
    les di, [bp+00ch]                         ; c4 7e 0c
    rep insb                                  ; f3 6c
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf8325 LB 0x4a6
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 31 93
    mov di, 00122h                            ; bf 22 01
    mov word [bp-020h], ax                    ; 89 46 e0
    mov word [bp-022h], strict word 00000h    ; c7 46 de 00 00
    jmp near 08749h                           ; e9 00 04
    cmp AL, strict byte 004h                  ; 3c 04
    jc short 08350h                           ; 72 03
    jmp near 087c1h                           ; e9 71 04
    mov cx, strict word 00010h                ; b9 10 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-046h]                         ; 8d 46 ba
    call 0a130h                               ; e8 d3 1d
    ...
    call 07e53h                               ; e8 cd fa
    test al, al                               ; 84 c0
    je short 08398h                           ; 74 0e
    push 00b92h                               ; 68 92 0b
    push 00bcbh                               ; 68 cb 0b
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 d1 95
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    test dx, dx                               ; 85 d2
    jne short 08406h                          ; 75 06
    cmp bx, 00200h                            ; 81 fb 00 02
    je short 08426h                           ; 74 20
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 12 95
    push dx                                   ; 52
    push word [bp-028h]                       ; ff 76 d8
    push word [bp-022h]                       ; ff 76 de
    push 00beah                               ; 68 ea 0b
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 46 95
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 0873dh                           ; e9 17 03
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 08439h                           ; 72 0c
    jbe short 08441h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 08449h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 08445h                           ; 74 0e
    jmp short 08492h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 08492h                          ; 75 55
    mov BL, strict byte 090h                  ; b3 90
    jmp short 0844bh                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 0844bh                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 0844bh                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov cl, bl                                ; 88 d9
    add cl, 007h                              ; 80 c1 07
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 016ach                               ; e8 55 92
    test al, al                               ; 84 c0
    je short 08492h                           ; 74 37
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 016ach                               ; e8 48 92
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    mov al, bl                                ; 88 d8
    call 016ach                               ; e8 3c 92
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    cwd                                       ; 99
    mov si, ax                                ; 89 c6
    ...
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 016ach                               ; e8 2c 92
    xor ah, ah                                ; 30 e4
    mov word [bp-018h], ax                    ; 89 46 e8
    mov ax, cx                                ; 89 c8
    call 016ach                               ; e8 22 92
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    jmp near 08580h                           ; e9 ee 00
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov bx, word [bp-010h]                    ; 8b 5e f0
    mov cx, word [bp-01ch]                    ; 8b 4e e4
    mov dx, word [bp-014h]                    ; 8b 56 ec
    mov si, strict word 0000ch                ; be 0c 00
    call 0a110h                               ; e8 6c 1c
    mov word [bp-02ah], ax                    ; 89 46 d6
    mov word [bp-016h], bx                    ; 89 5e ea
    mov word [bp-01ah], cx                    ; 89 4e e6
    mov word [bp-01eh], dx                    ; 89 56 e2
    mov ax, word [bp-012h]                    ; 8b 46 ee
    test ax, ax                               ; 85 c0
    jnbe short 084cch                         ; 77 15
    je short 084bch                           ; 74 03
    jmp near 08541h                           ; e9 85 00
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    jnbe short 084cch                         ; 77 0a
    jne short 084b9h                          ; 75 f5
    cmp word [bp-01ch], strict byte 00040h    ; 83 7e e4 40
    jnbe short 084cch                         ; 77 02
    jne short 08541h                          ; 75 75
    ...
    adc ax, bx                                ; 11 d8
    jmp short 08580h                          ; eb 3f
    test ax, ax                               ; 85 c0
    jnbe short 08557h                         ; 77 12
    jne short 08563h                          ; 75 1c
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    jnbe short 08557h                         ; 77 0a
    jne short 08563h                          ; 75 14
    cmp word [bp-01ch], strict byte 00020h    ; 83 7e e4 20
    jnbe short 08557h                         ; 77 02
    jne short 08563h                          ; 75 0c
    mov word [bp-018h], 00080h                ; c7 46 e8 80 00
    mov word [bp-026h], strict word 00020h    ; c7 46 da 20 00
    jmp short 0857ch                          ; eb 19
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 c3 8f
    inc byte [bp-00ch]                        ; fe 46 f4
    jmp near 08732h                           ; e9 91 00
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 77 92
    push word [bp-022h]                       ; ff 76 de
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 a9 92
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    test byte [bp-00245h], 080h               ; f6 86 bb fd 80
    je short 086d4h                           ; 74 05
    mov dx, strict word 00001h                ; ba 01 00
    jmp short 086d6h                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    sal ax, 002h                              ; c1 e0 02
    ...
    jl short 08749h                           ; 7c 03
    jmp near 087c1h                           ; e9 78 00
    ...
    lea bx, [bp-046h]                         ; 8d 5e ba
    mov ax, word [bp-00248h]                  ; 8b 86 b8 fd
    call 07e53h                               ; e8 d7 f6
    test al, al                               ; 84 c0
    je short 0878eh                           ; 74 0e
    push 00b92h                               ; 68 92 0b
    push 00bb2h                               ; 68 b2 0b
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 db 91
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp-020h]                         ; 8e 46 e0
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 087aah                          ; 75 0a
    test byte [bp-00246h], 01fh               ; f6 86 ba fd 1f
    jne short 087aah                          ; 75 03
    jmp near 08349h                           ; e9 9f fb
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 08732h                          ; 75 81
    mov al, byte [bp-00246h]                  ; 8a 86 ba fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    jne short 087beh                          ; 75 03
    jmp near 086a1h                           ; e9 e3 fe
    jmp near 08732h                           ; e9 71 ff
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_pci_init_:                              ; 0xf87cb LB 0x2a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    call 09ef2h                               ; e8 1f 17
    mov bx, ax                                ; 89 c3
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je short 087eeh                           ; 74 14
    mov dl, bl                                ; 88 da
    xor dh, dh                                ; 30 f6
    shr bx, 008h                              ; c1 eb 08
    mov al, bl                                ; 88 d8
    ...
    mov bx, strict word 00004h                ; bb 04 00
    call 09fbbh                               ; e8 cd 17
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop cx                                    ; 59
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf87f5 LB 0x81
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 6b 8e
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08872h                          ; 75 15
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 08325h                               ; e8 bc fa
    mov dx, strict word 00054h                ; ba 54 00
    mov ax, 01000h                            ; b8 00 10
    call 087cbh                               ; e8 59 ff
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf8876 LB 0x1c
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, ax                                ; 89 c6
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf8892 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf88b0 LB 0x156
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 088d3h                          ; 75 03
    jmp near 089feh                           ; e9 2b 01
    ...
    jne short 08991h                          ; 75 04
    test AL, strict byte 001h                 ; a8 01
    je short 08995h                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08997h                          ; eb 02
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 08964h                           ; 74 c9
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov di, ax                                ; 89 c7
    sal di, 007h                              ; c1 e7 07
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf8a06 LB 0x267
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf8c6d LB 0x180
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 08cf1h                           ; 74 07
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08cf3h                          ; eb 05
    jmp near 08de4h                           ; e9 f3 00
    xor al, al                                ; 30 c0
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08cc1h                           ; 74 ca
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, di                                ; 89 f8
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    call 0a130h                               ; e8 2c 14
    lea ax, [di+00080h]                       ; 8d 85 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    call 0a130h                               ; e8 1d 14
    lea ax, [di+00200h]                       ; 8d 85 00 02
    mov cx, strict word 00060h                ; b9 60 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    call 0a130h                               ; e8 0e 14
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-00ch], ax                    ; 89 46 f4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8ded LB 0x24d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    xchg dx, ax                               ; 92
    test ax, 0c011h                           ; a9 11 c0
    je short 08e72h                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08e74h                          ; eb 02
    xor al, al                                ; 30 c0
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08e3dh                           ; 74 c5
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a130h                               ; e8 ab 12
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a130h                               ; e8 9c 12
    lea di, [si+00200h]                       ; 8d bc 00 02
    mov cx, strict word 00060h                ; b9 60 00
    xor bx, bx                                ; 31 db
    mov ax, di                                ; 89 f8
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a130h                               ; e8 8b 12
    mov bl, byte [bp-008h]                    ; 8a 5e f8
    xor bh, bh                                ; 30 ff
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf903a LB 0xa8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    cmp bx, strict byte 00004h                ; 83 fb 04
    jbe short 09060h                          ; 76 0f
    push bx                                   ; 53
    push 00c62h                               ; 68 62 0c
    push 00c74h                               ; 68 74 0c
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 09 89
    add sp, strict byte 00008h                ; 83 c4 08
    xor di, di                                ; 31 ff
    les si, [bp+004h]                         ; c4 76 04
    ...
    xor ax, ax                                ; 31 c0
    call 08dedh                               ; e8 60 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, si                                ; 89 f0
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 08a06h                               ; e8 6e f9
    mov word [bp-006h], ax                    ; 89 46 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, si                                ; 89 f3
    mov ax, word [es:bx+00eh]                 ; 26 8b 47 0e
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf90e2 LB 0x86
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    cmp dx, strict byte 00004h                ; 83 fa 04
    jbe short 0910ch                          ; 76 0f
    push dx                                   ; 52
    push 00c93h                               ; 68 93 0c
    push 00c74h                               ; 68 74 0c
    push strict byte 00007h                   ; 6a 07
    call 01966h                               ; e8 5d 88
    add sp, strict byte 00008h                ; 83 c4 08
    xor bx, bx                                ; 31 db
    mov es, cx                                ; 8e c1
    ...
    mov dx, word [es:si+00232h]               ; 26 8b 94 32 02
    xor ax, ax                                ; 31 c0
    call 08dedh                               ; e8 b6 fc
    mov bx, strict word 00035h                ; bb 35 00
    mov ax, si                                ; 89 f0
    mov dx, cx                                ; 89 ca
    call 08a06h                               ; e8 c5 f8
    mov dx, ax                                ; 89 c2
    mov es, cx                                ; 8e c1
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
ahci_cmd_packet_:                            ; 0xf9168 LB 0x18a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 e9 84
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 091aeh                          ; 75 1f
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 89 87
    push 00ca6h                               ; 68 a6 0c
    push 00cb6h                               ; 68 b6 0c
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 c1 87
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 092e9h                           ; e9 3b 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    ...
    jne short 092e7h                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 092e9h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
wait_ticks_device_init_:                     ; 0xf92f2 LB 0x5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_detect_device_:                    ; 0xf92f7 LB 0x4ee
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    xor ch, ch                                ; 30 ed
    mov bx, cx                                ; 89 cb
    call 08dedh                               ; e8 d6 fa
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166ch                               ; e8 4c 83
    mov word [bp-010h], 00122h                ; c7 46 f0 22 01
    mov word [bp-016h], ax                    ; 89 46 ea
    mov ax, cx                                ; 89 c8
    sal ax, 007h                              ; c1 e0 07
    ...
    jc short 093c9h                           ; 72 11
    mov ax, word [es:di+002h]                 ; 26 8b 45 02
    cmp ax, word [bp-024h]                    ; 3b 46 dc
    jne short 09415h                          ; 75 54
    mov ax, word [es:di]                      ; 26 8b 05
    cmp ax, word [bp-01ah]                    ; 3b 46 e6
    jnc short 09415h                          ; 73 4c
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    sal ax, 007h                              ; c1 e0 07
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08876h                               ; e8 68 f4
    cmp ax, strict word 00003h                ; 3d 03 00
    jne short 093ach                          ; 75 99
    jmp short 0941eh                          ; eb 09
    cmp word [bp-01ch], strict byte 00000h    ; 83 7e e4 00
    jne short 0941eh                          ; 75 03
    jmp near 097ddh                           ; e9 bf 03
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-020h]                    ; 8b 46 e0
    mov dx, word [bp-01eh]                    ; 8b 56 e2
    call 08876h                               ; e8 48 f4
    cmp ax, strict word 00003h                ; 3d 03 00
    jne short 0941bh                          ; 75 e8
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    xor ah, ah                                ; 30 e4
    mov di, ax                                ; 89 c7
    sal di, 007h                              ; c1 e7 07
    ...
    test bx, bx                               ; 85 db
    jne short 0954ch                          ; 75 57
    cmp ax, 00101h                            ; 3d 01 01
    jne short 0954ch                          ; 75 52
    mov es, [bp-016h]                         ; 8e 46 ea
    mov bx, word [bp-010h]                    ; 8b 5e f0
    mov word [es:bx+006h], strict word 00000h ; 26 c7 47 06 00 00
    ...
    mov word [bp-028h], ax                    ; 89 46 d8
    mov si, word [bp-001bah]                  ; 8b b6 46 fe
    mov di, word [bp-001b8h]                  ; 8b be 48 fe
    xor ax, ax                                ; 31 c0
    mov word [bp-014h], ax                    ; 89 46 ec
    mov word [bp-022h], ax                    ; 89 46 de
    cmp di, 00fffh                            ; 81 ff ff 0f
    jne short 09599h                          ; 75 1b
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 09599h                          ; 75 16
    mov ax, word [bp-00164h]                  ; 8b 86 9c fe
    mov word [bp-022h], ax                    ; 89 46 de
    mov ax, word [bp-00166h]                  ; 8b 86 9a fe
    mov word [bp-014h], ax                    ; 89 46 ec
    mov di, word [bp-00168h]                  ; 8b be 98 fe
    mov si, word [bp-0016ah]                  ; 8b b6 96 fe
    mov bl, byte [bp-008h]                    ; 8a 5e f8
    xor bh, bh                                ; 30 ff
    mov es, [bp-016h]                         ; 8e 46 ea
    ...
    mov ax, word [bp-014h]                    ; 8b 46 ec
    mov word [es:bx+03ah], ax                 ; 26 89 47 3a
    mov word [es:bx+038h], di                 ; 26 89 7f 38
    mov word [es:bx+036h], si                 ; 26 89 77 36
    mov ax, word [bp-026h]                    ; 8b 46 da
    mov word [es:bx+030h], ax                 ; 26 89 47 30
    mov ax, word [bp-02ch]                    ; 8b 46 d4
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 09611h                           ; 72 0c
    jbe short 09619h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 09621h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0961dh                           ; 74 0e
    jmp short 0966dh                          ; eb 5c
    test al, al                               ; 84 c0
    jne short 0966dh                          ; 75 58
    mov BL, strict byte 040h                  ; b3 40
    jmp short 09623h                          ; eb 0a
    mov BL, strict byte 048h                  ; b3 48
    jmp short 09623h                          ; eb 06
    mov BL, strict byte 050h                  ; b3 50
    jmp short 09623h                          ; eb 02
    mov BL, strict byte 058h                  ; b3 58
    mov dl, bl                                ; 88 da
    add dl, 007h                              ; 80 c2 07
    xor dh, dh                                ; 30 f6
    mov ax, dx                                ; 89 d0
    call 016ach                               ; e8 7d 80
    test al, al                               ; 84 c0
    je short 0966dh                           ; 74 3a
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 016ach                               ; e8 70 80
    xor ah, ah                                ; 30 e4
    sal ax, 008h                              ; c1 e0 08
    mov word [bp-02ah], ax                    ; 89 46 d6
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 016ach                               ; e8 61 80
    xor ah, ah                                ; 30 e4
    ...
    mov al, bl                                ; 88 d8
    add AL, strict byte 002h                  ; 04 02
    call 016ach                               ; e8 50 80
    xor ah, ah                                ; 30 e4
    mov word [bp-032h], ax                    ; 89 46 ce
    mov ax, dx                                ; 89 d0
    call 016ach                               ; e8 46 80
    xor ah, ah                                ; 30 e4
    mov word [bp-02eh], ax                    ; 89 46 d2
    jmp short 0967dh                          ; eb 10
    push word [bp-022h]                       ; ff 76 de
    push word [bp-014h]                       ; ff 76 ec
    push di                                   ; 57
    push si                                   ; 56
    ...
    call 05a41h                               ; e8 c4 c3
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 9b 82
    push word [bp-022h]                       ; ff 76 de
    push word [bp-014h]                       ; ff 76 ec
    push di                                   ; 57
    push si                                   ; 56
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0165eh                               ; e8 49 7f
    jmp near 097cch                           ; e9 b4 00
    cmp bx, 0eb14h                            ; 81 fb 14 eb
    jne short 09775h                          ; 75 57
    cmp ax, 00101h                            ; 3d 01 01
    jne short 09775h                          ; 75 52
    mov es, [bp-016h]                         ; 8e 46 ea
    mov bx, word [bp-010h]                    ; 8b 5e f0
    mov word [es:bx+006h], strict word 00000h ; 26 c7 47 06 00 00
    mov word [es:bx+004h], strict word 00000h ; 26 c7 47 04 00 00
    ...
    mov ax, word [bp-010h]                    ; 8b 46 f0
    mov dx, es                                ; 8c c2
    call 08a06h                               ; e8 a3 f2
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    mov byte [bp-00ch], al                    ; 88 46 f4
    test byte [bp-00232h], 080h               ; f6 86 ce fd 80
    je short 09777h                           ; 74 07
    mov dx, strict word 00001h                ; ba 01 00
    jmp short 09779h                          ; eb 04
    jmp short 097cch                          ; eb 55
    xor dx, dx                                ; 31 d2
    mov bl, byte [bp-008h]                    ; 8a 5e f8
    xor bh, bh                                ; 30 ff
    mov es, [bp-016h]                         ; 8e 46 ea
...
ahci_mem_alloc_:                             ; 0xf97e5 LB 0x43
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf9828 LB 0x16d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov word [bp-010h], ax                    ; 89 46 f0
    test ax, ax                               ; 85 c0
    jne short 0986ch                          ; 75 03
    jmp near 09974h                           ; e9 08 01
    mov ax, word [bp-010h]                    ; 8b 46 f0
    mov es, di                                ; 8e c7
    ...
    xor cx, cx                                ; 31 c9
    call 08876h                               ; e8 6a ef
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    jmp short 09938h                          ; eb 21
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 0992fh                           ; 74 12
    mov bl, byte [bp-00eh]                    ; 8a 5e f2
    xor bh, bh                                ; 30 ff
    xor ax, ax                                ; 31 c0
    mov dx, word [bp-010h]                    ; 8b 56 f0
    call 092f7h                               ; e8 cd f9
    dec byte [bp-00ch]                        ; fe 4e f4
    je short 09972h                           ; 74 43
    inc byte [bp-00eh]                        ; fe 46 f2
    cmp byte [bp-00eh], 020h                  ; 80 7e f2 20
    jnc short 09972h                          ; 73 3a
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 0996eh                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 09917h                           ; 74 a9
    mov AL, strict byte 001h                  ; b0 01
    jmp short 09919h                          ; eb a7
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 07eh, 09ah, 05ch, 09ah, 062h, 09ah, 068h, 09ah, 06eh
    db  09ah, 074h, 09ah, 07ah, 09ah, 07eh, 09ah
_ahci_init:                                  ; 0xf9995 LB 0x13a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09eeah                               ; e8 44 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je short 099f9h                           ; 74 4c
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-006h], al                    ; 88 46 fa
    mov byte [bp-00ah], dl                    ; 88 56 f6
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09f15h                               ; e8 53 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 099fch                           ; 74 34
    mov bl, cl                                ; 88 cb
    xor bh, bh                                ; 30 ff
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    mov ax, word [bp-014h]                    ; 8b 46 ec
    call 09f15h                               ; e8 2e 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 099fch                           ; 74 11
    mov bl, cl                                ; 88 cb
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    xor bh, bh                                ; 30 ff
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    mov ax, word [bp-014h]                    ; 8b 46 ec
    jmp short 099bfh                          ; eb c6
    jmp near 09ac8h                           ; e9 cc 00
    test cl, cl                               ; 84 c9
    je short 099f9h                           ; 74 f9
    ...
    mov dx, word [bp-012h]                    ; 8b 56 ee
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    call 09f15h                               ; e8 f3 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne short 099f9h                          ; 75 d3
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    mov bl, cl                                ; 88 cb
    ...
    mov dx, word [bp-012h]                    ; 8b 56 ee
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    call 09f43h                               ; e8 09 05
    mov dx, ax                                ; 89 c2
    and ax, strict word 0000fh                ; 25 0f 00
    sub ax, strict word 00004h                ; 2d 04 00
    cmp ax, strict word 0000bh                ; 3d 0b 00
    jnbe short 09a7eh                         ; 77 37
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00008h                ; b9 08 00
    mov di, 0997eh                            ; bf 7e 99
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di-0667bh]               ; 2e 8b 85 85 99
    jmp ax                                    ; ff e0
    ...
    jmp short 09a7eh                          ; eb 10
    mov byte [bp-008h], 01ch                  ; c6 46 f8 1c
    jmp short 09a7eh                          ; eb 0a
    mov byte [bp-008h], 020h                  ; c6 46 f8 20
    jmp short 09a7eh                          ; eb 04
    ...
    mov dx, word [bp-010h]                    ; 8b 56 f0
    mov ax, word [bp-016h]                    ; 8b 46 ea
    call 09f6dh                               ; e8 c1 04
    test AL, strict byte 001h                 ; a8 01
    je short 09ac8h                           ; 74 18
    and AL, strict byte 0f0h                  ; 24 f0
    add si, ax                                ; 01 c6
    mov cx, strict word 00007h                ; b9 07 00
    mov bx, strict word 00004h                ; bb 04 00
    mov dx, word [bp-010h]                    ; 8b 56 f0
    mov ax, word [bp-016h]                    ; 8b 46 ea
    call 09fbbh                               ; e8 f8 04
    mov ax, si                                ; 89 f0
    call 09828h                               ; e8 60 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf9acf LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 09ae4h                           ; 74 0a
    mov al, byte [bx]                         ; 8a 07
    out DX, AL                                ; ee
    inc bx                                    ; 43
    mov al, byte [bx]                         ; 8a 07
    db  00ah, 0c0h
    ; or al, al                                 ; 0a c0
    jne short 09adch                          ; 75 f8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
    sub word [bp+di-0644fh], bx               ; 29 9b b1 9b
    cmp bx, word [bp+di-064aah]               ; 3b 9b 56 9b
    mov CL, strict byte 09bh                  ; b1 9b
    sbb word [bp+di-0644fh], 09bb7h           ; 81 9b b1 9b b7 9b
    xchg byte [bp+di-0647ah], bl              ; 86 9b 86 9b
    xchg byte [bp+di-0640ah], bl              ; 86 9b f6 9b
    xchg byte [bp+di-0647ah], bl              ; 86 9b 86 9b
    out DX, ax                                ; ef
    wait                                      ; 9b
_apm_function:                               ; 0xf9b08 LB 0xf3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jnbe short 09b86h                         ; 77 6c
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06516h]                   ; 2e ff a7 ea 9a
    ...
    jmp near 09bb1h                           ; e9 30 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 09bb1h                           ; e9 2b 00
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 92 7d
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00d29h                               ; 68 29 0d
    push strict byte 00004h                   ; 6a 04
    call 01966h                               ; e8 c7 7d
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    je short 09bdch                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09bd4h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09be4h                          ; 75 1b
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d10h                            ; b8 10 0d
    call 09acfh                               ; e8 fd fe
    jmp short 09bb1h                          ; eb dd
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d18h                            ; b8 18 0d
    jmp short 09bcfh                          ; eb f3
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d20h                            ; b8 20 0d
    jmp short 09bcfh                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 09bb1h                          ; eb c2
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 09bb1h                          ; eb bb
    or ah, 080h                               ; 80 cc 80
    jmp short 09be7h                          ; eb ec
pci16_select_reg_:                           ; 0xf9bfb LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf9c1f LB 0xf9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09c67h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 09bfbh                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09c55h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 09ce8h                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 09c62h                           ; 74 07
    mov word [bp-010h], strict word 00001h    ; c7 46 f0 01 00
    jmp short 09c67h                          ; eb 05
    mov word [bp-010h], strict word 00008h    ; c7 46 f0 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 09c8fh                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 09c8fh                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 09bfbh                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 09c8fh                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 09c98h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 09c9ah                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 09bfbh                               ; e8 5c ff
    ...
    xor ah, ah                                ; 30 e4
    cmp dx, ax                                ; 39 c2
    jnbe short 09cf9h                         ; 77 03
    jmp near 09c35h                           ; e9 3c ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 09d02h                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 09d05h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    stc                                       ; f9
    popfw                                     ; 9d
    adc bl, byte [bp-061dch]                  ; 12 9e 24 9e
    cmp byte [bp-061b6h], bl                  ; 38 9e 4a 9e
    pop bp                                    ; 5d
    sahf                                      ; 9e
_pci16_function:                             ; 0xf9d18 LB 0x1d2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 09d4ah                           ; 72 13
    jbe short 09d9dh                          ; 76 64
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je short 09da5h                           ; 74 67
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc short 09d54h                           ; 72 11
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe short 09da8h                          ; 76 60
    jmp short 09d54h                          ; eb 0a
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09d73h                           ; 74 24
    cmp bx, strict byte 00001h                ; 83 fb 01
    je short 09d57h                           ; 74 03
    jmp near 09eb6h                           ; e9 5f 01
    ...
    jmp near 09ee3h                           ; e9 70 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09d7fh                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09edch                           ; e9 5d 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 09c1fh                               ; e8 92 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09d9fh                          ; 75 0d
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09edch                           ; e9 3f 01
    jmp short 09daah                          ; eb 0b
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09ee3h                           ; e9 3e 01
    jmp near 09e71h                           ; e9 c9 00
    jmp short 09dcfh                          ; eb 25
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 09c1fh                               ; e8 66 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09dc9h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09edch                           ; e9 13 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09ee3h                           ; e9 14 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 09ddch                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09edch                           ; e9 00 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 09bfbh                               ; e8 16 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe short 09e5ah                         ; 77 68
    add bx, bx                                ; 01 db
    jmp word [cs:bx-062f4h]                   ; 2e ff a7 0c 9d
    ...
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09ee3h                          ; eb 2d
    mov bx, 00da0h                            ; bb a0 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01923h                               ; e8 62 7a
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9eea LB 0x8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov ax, strict word 0ffffh                ; b8 ff ff
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_device_:                            ; 0xf9ef2 LB 0x23
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9f15 LB 0x2e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9f43 LB 0x2a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9f6d LB 0x4e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    int 01ah                                  ; cd 1a
    test cx, cx                               ; 85 c9
    je short 09fb1h                           ; 74 05
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 09fb3h                          ; eb 02
    xor ax, ax                                ; 31 c0
    cwd                                       ; 99
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_write_config_word_:                      ; 0xf9fbb LB 0x25
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9fe0 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9ffd LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xfa01b LB 0x77
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09fe0h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 0a062h                           ; 74 11
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc short 0a05fh                           ; 72 02
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 0a089h                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xfa092 LB 0x2e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09fe0h                               ; e8 44 ff
    test ax, ax                               ; 85 c0
    je short 0a0b1h                           ; 74 11
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc short 0a0b0h                           ; 72 02
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
hard_drive_post:                             ; 0xfe2d2 LB 0xa7
    ...
    pop DS                                    ; 1f
    cld                                       ; fc
    call 01c9fh                               ; e8 7b 39
    call 02118h                               ; e8 f1 3d
    sti                                       ; fb
    call 09995h                               ; e8 6a b6
    cli                                       ; fa
    call 087f5h                               ; e8 c6 a4
    call 0ed2fh                               ; e8 fd 09
    ...
    call 0178dh                               ; e8 49 34
    call 03b93h                               ; e8 4c 58
    sti                                       ; fb
    int 019h                                  ; cd 19
    sti                                       ; fb
    hlt                                       ; f4
...
int13_relocated:                             ; 0xfec5b LB 0x55
    ...
    jmp near 03bd7h                           ; e9 66 4f
    push ES                                   ; 06
    push ax                                   ; 50
    push bx                                   ; 53
    push cx                                   ; 51
    push dx                                   ; 52
    call 03babh                               ; e8 32 4f
    cmp AL, strict byte 000h                  ; 3c 00
    je short 0ecabh                           ; 74 2e
    call 03bc1h                               ; e8 41 4f
    pop dx                                    ; 5a
    push dx                                   ; 52
    db  03ah, 0c2h
    ; cmp al, dl                                ; 3a c2
...
int13_disk:                                  ; 0xfecdc LB 0xd
    ...
    call 05b28h                               ; e8 44 6e
    jmp short 0ece9h                          ; eb 03
    call 05f7bh                               ; e8 92 72
...
cpu_reset:                                   ; 0xffff0 LB 0x10
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    db  030h, 036h, 02fh, 032h, 033h, 02fh, 039h, 039h, 000h, 0fch, 0a2h
